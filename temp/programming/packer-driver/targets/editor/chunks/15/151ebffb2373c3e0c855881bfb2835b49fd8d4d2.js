    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function smartSortCards(cards) {
          ...
          const scatteredPart = []; // 单张/对子/三张（降序）

          const randomPart = []; // 飞机、顺子、连对、三带二（升序）
          ...
          const miscGroups = [...findPlane(getUnused()), ...findChainPairs(getUnused()), ...findStraight(getUnused()), ...findThreeWithTwo(getUnused())];
...
//# sourceMappingURL=151ebffb2373c3e0c855881bfb2835b49fd8d4d2.js.map