    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          const sorted = sortCardsBySizeDown(remaining.map(r => r.c), remaining.length); // 再按点数分组（保留重复）
          ...
          for (const group of rankMap.values()) {
            const selectedPart = [];
...
//# sourceMappingURL=d4791961aa7fc1ac307270b85f7ba0261f49d00d.js.map