  ...
  return {
    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getRemainCardsByDelete(value, deleteCards, keepOrder = false, select = []) {
          ...
          let tmpList = [];
          let sameSizeList = GameLogic.getSameCardSizeList(value, keepOrder, select);
        ...
        function getSameCardSizeList(value, keepOrder = false, select = []) {
          if (!keepOrder) {
            let tmpList = [];
...
//# sourceMappingURL=06c046208e4d2c0852adee7fc39d5bf45d16aef1.js.map