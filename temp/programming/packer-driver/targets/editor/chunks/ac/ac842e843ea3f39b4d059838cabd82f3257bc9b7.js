System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Toggle, utils, SoundManager, PopWindow, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, SetingItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "3c447+1IfxFW47vSiIXC2QC", "SetingItem", undefined);
      ...
      _export("SetingItem", SetingItem = (_dec = ccclass('SetingItem'), _dec2 = property(Toggle), _dec3 = property(Toggle), _dec(_class = (_class2 = class SetingItem extends (_crd && PopWindow === void 0 ? (_reportPossibleCrUseOfPopWindow({
        error: Error()
      }), PopWindow) : PopWindow) {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "soundToggle", _descriptor2, this);
        }
        ...
        start() {
          this.musicToggle.node.on('toggle', toggle => {
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).setMusic(toggle.isChecked);
          }, this);
          this.soundToggle.node.on('toggle', toggle => {
            console.log(`toggle sound ${toggle.isChecked}`);
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).setSound(toggle.isChecked);
          }, this);

          if ((_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
            error: Error()
          }), utils) : utils).getMusic()) {
...
//# sourceMappingURL=ac842e843ea3f39b4d059838cabd82f3257bc9b7.js.map