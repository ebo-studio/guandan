    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        updateSelectedCards_V() {
          ...
          function getSelectedIndexes(cards, selected) {
            const selectedCount = new Map();
            const indexes = [];

            for (let v of selected) {
              selectedCount.set(v, (selectedCount.get(v) || 0) + 1);
            }
          ...
          function getGroupedIndexes(cards, grouped) {
            const used = new Set();
            const result = [];
            ...
            for (const group of grouped) {
              ...
              result.push(groupIndexes);
            }

            return result;
          }

          function isSameIndexGroup(a, b) {
          ...
          const selectedIndexes = getSelectedIndexes(this.handCardsValue, this.selectCardValue);
          const groupedIndexes = getGroupedIndexes(this.handCardsValue, this.groupedCards);
          let isRecover = groupedIndexes.some(groupIdxs => isSameIndexGroup(groupIdxs, selectedIndexes));
...
//# sourceMappingURL=38002fa173411894ebf994f37ce01a792b011398.js.map