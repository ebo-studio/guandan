    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        updateSelectedCards_V() {
          ...
          function isSameGroupStrict(g1, g2) {
          ...
          const selectedSorted = [...this.selectCardValue].sort((a, b) => a - b);
          const len = this.selectCardValue.length; // 遍历理牌后的整副牌中所有等长片段，判断是否完全匹配

          for (let i = 0; i <= this.sorthandCardsValue.length - len; i++) {
            const slice = this.sorthandCardsValue.slice(i, i + len);

            if (isSameGroupStrict(slice, selectedSorted)) {
              isRecover = true;
              break;
            }
          }
...
//# sourceMappingURL=bcee2e8a69a71593d0af2aa508d6a1af4c785cc5.js.map