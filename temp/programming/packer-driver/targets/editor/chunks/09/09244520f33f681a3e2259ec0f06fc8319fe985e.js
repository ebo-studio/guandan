    ...
    execute: function () {
      ...
      (function (_utils) {
        ...
        function send(name, ...param) {
          (_crd && event === void 0 ? (_reportPossibleCrUseOfevent({
            error: Error()
          }), event) : event).trigger_event(name, param[0], param[1], param[2], param[3], param[4], param[5], param[6], param[7], param[8], param[9]);
        }
        ...
        function clampNickname(name, length = 5) {
          if (!name) return "";
          let size = 0;
        ...
        function sendHttpRequest(obj) {
          ...
          let xhr = new (_crd && httprequest === void 0 ? (_reportPossibleCrUseOfhttprequest({
            error: Error()
...
//# sourceMappingURL=09244520f33f681a3e2259ec0f06fc8319fe985e.js.map