            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                ...
                if (isAuto) {
                  this.groupedCards = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                    error: Error()
                  }), GameLogic) : GameLogic).removeOutCardsFromGrouped(this.groupedCards, tempCards); // GlobalData.cardInfo.sortCard = false;
                } else {
                  this.groupedCards = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                    error: Error()
...
//# sourceMappingURL=d9113d73941bf7a8e059b1875ead485598c2479f.js.map