System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Sprite, SpriteFrame, AItemRenderer, LobbyUserHeadItem, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, RankScorePersonLine;
  ...
  function _reportPossibleCrUseOfRankScorePersonLineData(extras) {
    _reporterNs.report("RankScorePersonLineData", "../../manager/GlobalData", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "874a3eCcydPi5p73CFYyc36", "RankScoreAuditionLine", undefined);
      ...
      _export("RankScorePersonLine", RankScorePersonLine = (_dec = ccclass('RankScorePersonLine'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(_crd && LobbyUserHeadItem === void 0 ? (_reportPossibleCrUseOfLobbyUserHeadItem({
        error: Error()
      }), LobbyUserHeadItem) : LobbyUserHeadItem), _dec5 = property(Sprite), _dec6 = property(SpriteFrame), _dec(_class = (_class2 = class RankScorePersonLine extends (_crd && AItemRenderer === void 0 ? (_reportPossibleCrUseOfAItemRenderer({
        error: Error()
...
//# sourceMappingURL=f909e81a75770b40a5e9c8d4a3a27ed40333a981.js.map