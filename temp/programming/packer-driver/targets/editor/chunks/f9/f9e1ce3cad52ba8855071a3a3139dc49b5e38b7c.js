    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function findFeiji(cards) {
          ...
          const rankToTriplet = new Map();
          let redLeft = redCount; // 尝试每个 rank 是否能组成三张（原生或拼红心）
          ...
          for (let i = 0; i < sortedRanks.length - 1; i++) {
            const group = [rankToTriplet.get(sortedRanks[i])];
...
//# sourceMappingURL=f9e1ce3cad52ba8855071a3a3139dc49b5e38b7c.js.map