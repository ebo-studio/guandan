System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, AVirtualScrollView, GlobalData, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, RankRaceKickItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "278b8RSBSxBUqH7ggVK4Ua7", "RankRaceKickItem", undefined);
      ...
      _export("RankRaceKickItem", RankRaceKickItem = (_dec = ccclass('RankRaceKickItem'), _dec2 = property(_crd && AVirtualScrollView === void 0 ? (_reportPossibleCrUseOfAVirtualScrollView({
        error: Error()
      }), AVirtualScrollView) : AVirtualScrollView), _dec3 = property(Node), _dec(_class = (_class2 = class RankRaceKickItem extends Component {
        constructor(...args) {
          super(...args);
        ...
        setData() {
          this.nodeTip.active = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).gameResultInfo.kickList.length == 0;
          ...
          if (this.personScroll.node.active) {
            this.personScroll.refreshData((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).gameResultInfo.kickList);
          }
        }
...
//# sourceMappingURL=f8596badc60b9d2e3a31ef7fa3113bd7ae9643fa.js.map