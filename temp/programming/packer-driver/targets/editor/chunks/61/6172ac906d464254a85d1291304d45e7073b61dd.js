    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function findBombsWithHeartSupport(groups) {
          const result = [];
          const sortedGroups = [...groups].sort((a, b) => a.length - b.length); // 拆分红心级牌与其他组

          const redCards = sortedGroups.flat().filter(c => isHeartCard(c));
          const normalGroups = sortedGroups.filter(g => !g.some(c => isHeartCard(c)));
...
//# sourceMappingURL=6172ac906d464254a85d1291304d45e7073b61dd.js.map