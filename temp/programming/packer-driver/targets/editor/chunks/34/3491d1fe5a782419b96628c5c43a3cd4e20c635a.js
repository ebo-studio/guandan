          ...
          if (viewid == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              this.groupedCards = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).removeOutCardsFromGrouped(that.groupedCards, this.handCardsValue); // this.groupedCards = GameLogic.smartSortCards(this.handCardsValue);
          ...
          if (this.outCardList.length == 1 && (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            while (checked < total) {
              ...
              if (hint.length === 1) {
                const card = hint[0];
                hintCard = card;
                const hintSize = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                  error: Error()
                }), GameLogic) : GameLogic).getCardSize(card);
                console.log('点数>>', hintSize); // ✅ 先从散牌中找一个比它大的

                const biggerSingles = grouped.filter(g => g.length === 1 && (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                  error: Error()
            ...
            if (!found && hintCard != null) {
              ...
              const pairs = grouped.filter(g => g.length === 2 && (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getCardSize(g[0]) >= hintSize).sort((a, b) => (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getCardSize(a[0]) - (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            ...
            if (!found && hintCard != null) {
              ...
              const triples = grouped.filter(g => g.length === 3 && (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getCardSize(g[0]) >= hintSize).sort((a, b) => (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getCardSize(a[0]) - (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
...
//# sourceMappingURL=3491d1fe5a782419b96628c5c43a3cd4e20c635a.js.map