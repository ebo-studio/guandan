  ...
  return {
    ...
    execute: function () {
      ...
      _export("Loading", Loading = (_dec = ccclass('Loading'), _dec2 = property(ProgressBar), _dec3 = property(Button), _dec(_class = (_class2 = class Loading extends Component {
        ...
        async loadPrefabsSequentially() {
          for (const name of this.prefabNames) {
            await this.loadOne(`prefab/${name}`);
            this.finished++;
            this.updateProgress();
          }
        }
        ...
        updateProgress(progress) {
          let p = progress != null ? progress : this.finished / (this.total + 1);
...
//# sourceMappingURL=8067b719e7aa6f8a5393000f3e69f108fc584e55.js.map