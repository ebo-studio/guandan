        ...
        onHandleBtn(data) {
          ...
          if (data.hitCards && data.hitCards.length > 0) {
            ...
            this.hintCards.sort((a, b) => {
              ...
              const aSize = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getCardSize(a[0]);
              const bSize = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
...
//# sourceMappingURL=bb4103a0f3bc8708e97e1a532891453b1a4e981c.js.map