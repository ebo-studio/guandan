  ...
  return {
    ...
    execute: function () {
      ...
      (function (_GlobalData) {
        const sceneName = _GlobalData.sceneName = {
          start: "Start",
          lobby: "Lobby",
          game: "Game"
        };
        const gameType = _GlobalData.gameType = {
          /**1*/
          free: 1,
          //自由赛
        ...
        const keyCards = _GlobalData.keyCards = {
          1: "A",
          2: "2",
          3: "3",
          4: "4",
        ...
        const keyLevelCards = _GlobalData.keyLevelCards = {
          2: 2,
          3: 3,
          4: 4,
          5: 5,
        ...
        const viewId = _GlobalData.viewId = {
          up: 0,
          //上家
          self: 1,
          //自己
        ...
        const MAXPLAYER = _GlobalData.MAXPLAYER = 4;
        const localEvent = _GlobalData.localEvent = {
        ...
        const C2S_Event = _GlobalData.C2S_Event = {
          Ping: 1,
          //心跳（每秒钟一次，3秒无心跳自动断线)
          Login: 2,
          //登录
        ...
        const S2C_Event = _GlobalData.S2C_Event = {
          /**1  心跳*/
          Pong: 1,
        ...
        const cardInfo = _GlobalData.cardInfo = {
          /**
          * 当前的级牌（即参谋)
          */
          levelCard: 1,
          ...
          */
           ...
           * 打自己的
          */
          // cardDir: false, //true:横向 false:纵向
          sortCard: false,
          //理牌
          oneCard: false //一键理牌

        };
        const createRoomInfo = _GlobalData.createRoomInfo = {
          timeList: [15, 30],
          time: null //1->15s 2->30s

        };
        const gameResultInfo = _GlobalData.gameResultInfo = {
          scoreList: [],
          //积分
          kickList: [],
          //淘汰
        ...
        const teamInfo = _GlobalData.teamInfo = {
          list: []
        };
        const rankScorePersonInfo = _GlobalData.rankScorePersonInfo = {
          list: [],
          my: null
        };
        const rankScoreTeamInfo = _GlobalData.rankScoreTeamInfo = {
          list: [],
          my: null
        };
        const raceScoreDataInfo = _GlobalData.raceScoreDataInfo = {
          list: []
        };
        const raceKickDataInfo = _GlobalData.raceKickDataInfo = {
          list: []
        };
        const raceAuditionDataInfo = _GlobalData.raceAuditionDataInfo = {
          list: []
        };
        const raceKickUpInfo = _GlobalData.raceKickUpInfo = {
          list: []
        };
        const raceAuditionInfo = _GlobalData.raceAuditionInfo = {
          list: []
        };
        const loginInfo = _GlobalData.loginInfo = {
          code: "11",
          token: ""
        };
        const userInfo = _GlobalData.userInfo = {
          haveToken: false,
          //登录获取的token
          user_id: 0,
          //用户id
...
//# sourceMappingURL=260da163cca52efa963f83d8e6849cf6a358e5a6.js.map