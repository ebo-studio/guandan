    ...
    execute: function () {
      ...
      _export("default", AVirtualScrollView = (_dec = property({
        ...
        onLoad() {
          ...
          let itemNode = this.itemRenderer.data.getComponent(UITransform);
        ...
        */
        ...
        addItem() {
          ...
          if (itemListLen < len) {
            ...
            let cL = this.content.children.length;
            let item;
        ...
        refreshHorizontal() {
          ...
          let start = Math.floor(Math.abs(this._contentPos.x) / this.itemW);
        ...
        refreshVertical() {
          let start = Math.floor(Math.abs(this._contentPos.y) / this.itemH);
        ...
        refreshGrid() {
          //是否垂直方向 添加网格
          let isVDirection = this.contentLayout.startAxis == Layout.AxisDirection.VERTICAL; //_contentPos

          let start = Math.floor(Math.abs(this._contentPos.y) / this.itemH) * this.horizontalCount;
...
//# sourceMappingURL=2a729184414d0344d5f8867d1a25b85114d7afc1.js.map