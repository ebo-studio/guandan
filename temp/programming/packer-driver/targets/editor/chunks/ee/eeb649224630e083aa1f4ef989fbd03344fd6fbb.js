    ...
    execute: function () {
      ...
      (function (_GameSocket) {
        ...
        function initAndConnect() {
          ...
          let url = (_crd && UrlConfig === void 0 ? (_reportPossibleCrUseOfUrlConfig({
            error: Error()
        ...
        function onGameSocketOpen() {
          ...
          let baseInfo = GameMsg.Login.create({
        ...
        function onGameSocketMessage(data) {
          let recData = (_crd && PbManager === void 0 ? (_reportPossibleCrUseOfPbManager({
            error: Error()
          ...
          if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.UserList, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).S2C_Event.UserList) {
            let users = GameMsg.UserList.decode(recData.msg);
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.StartHandCard, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.OutCardTime, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.HandleBtn, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.OutCards, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.LeftCards, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.UserWin, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).S2C_Event.HaveWindy) {
            let users = GameMsg.UserWin.decode(recData.msg); // console.log("-----> HaveWindy ", users);

            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).send((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).localEvent.HaveWindy, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.GameFinish, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).S2C_Event.NoCard) {
            let users = GameMsg.KongGong.decode(recData.msg); // console.log("-----> NoCard ", users);

            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).send((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).localEvent.NoCard, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).S2C_Event.UpCard) {
            let users = GameMsg.GongList.decode(recData.msg); // console.log("-----> upCard ", users);

            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).send((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).localEvent.UpCard, users);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).S2C_Event.ReviceCardDownUp) {
            let users = GameMsg.Gong.decode(recData.msg); // console.log("-----> ReviceCardDownUp ", users);

            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).send((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).localEvent.ReviceCard, users, true);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).S2C_Event.ReviceCardUpDown) {
            let users = GameMsg.Gong.decode(recData.msg); // console.log("-----> ReviceCardUpDown ", users);

            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).send((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).localEvent.ReviceCard, users, false);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).S2C_Event.DownCard) {
            let users = GameMsg.Gong.decode(recData.msg); // console.log("-----> downCard ", users);

            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).send((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).localEvent.DownCard, users, false);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            let users = GameMsg.Gong.decode(recData.msg); // console.log("-----> DownCardAuto ", users);

            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).send((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).localEvent.DownCard, users, true);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.LeftCardCnt, users.card);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.KickRoomId, msg.roomId);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.AuditionRoomId, msg.roomId);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.ScoreMatchSucces, msg);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.KickFinish, msg.roomId);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.ScoreFinish, msg.roomId);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.ReconnectOutCard, msg);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.Reconnect, msg);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.FreeMatchStart, msg);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.AuditionMatchStart, msg);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.GameError, msg);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.KickGameInfo, msg);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).S2C_Event.ReconnecteKangGong) {
            let msg = GameMsg.KongGong.decode(recData.msg); // console.log("断线抗贡 ", msg);

            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).send((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).localEvent.KangGong, false, msg.one, msg.two);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
            ...
            (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              ...
              error: Error()
            }), GlobalData) : GlobalData).localEvent.GameFinishCards, msg);
          } else if (recData.id == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
        ...
        function startHeart() {
          ...
          heartInterval = setInterval(() => {
            let buf = (_crd && PbManager === void 0 ? (_reportPossibleCrUseOfPbManager({
              error: Error()
            }), PbManager) : PbManager).instance.sendMsg((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
...
//# sourceMappingURL=eeb649224630e083aa1f4ef989fbd03344fd6fbb.js.map