        ...
        function findStraightByCard(cards) {
          ...
          for (const seq of seqList) {
            ...
            for (const r of seq) {
              ...
              if (r === 2) {
                for (let i = 0; i < cards.length; i++) {
                  if (getCardRank(cards[i]) === 2 && getCardColor(cards[i]) === HONGTAO && !usedIndex.has(i)) {
                    foundIdx = i;
                    break;
                  }
                }
              } else {
                const candidateIdxList = rankMap.get(r);
                ...
                for (const i of candidateIdxList) {
                  if (!usedIndex.has(i)) {
                    foundIdx = i;
                    break;
                  }
            ...
            if (valid) {
              const groupCards = groupIndexes.map(i => cards[i]);
...
//# sourceMappingURL=54dd35b4f0e404984eeb3c4eeb20daddc870fdd3.js.map