          ...
          if (viewid == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                ...
                sameSizeList = this.groupedCards; // 初始化布局

                this.initHandStartPosX_V(sameSizeList.length);
                let idx = 0;
                let usedCardSet = new Set();
                this.setCanTouch(false);
                ...
                for (let i = 0; i < sameSizeList.length; i++) {
                  ...
                  for (let j = list.length - 1; j >= 0; j--) {
                    const cardValue = list[j]; // 找到未被使用的 CardItem（牌节点）

                    for (let n = 0; n < this.handCards.length; n++) {
                      const card = this.handCards[n];
                      ...
                      if (card.getValue() === cardValue && !usedCardSet.has(card.getIndex())) {
                        ...
                        const moveFunc = (posX, posY, index) => {
...
//# sourceMappingURL=53758dcf8b63ab828519e36cb978a8d60f981297.js.map