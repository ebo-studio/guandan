    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected) {
          ...
          const selectedSet = new Set(selectedHistory); // 2. 从历史中判断是否有三带二

          const map = getCardCountMap(selectedHistory); // Map<点数, number[]>
          ...
          let usedRanks = new Set(); // 用点数标记组合过的
...
//# sourceMappingURL=5016eb9bba738807dad5dd8abd8b61acee4eda1d.js.map