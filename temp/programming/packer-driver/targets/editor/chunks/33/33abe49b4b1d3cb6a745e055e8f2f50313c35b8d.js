    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          const moveToBack = [];
          const selectedSet = new Set(selected);
          const prevSet = new Set(prevSelected); // const usedCards = new Set<number>();
          ...
          const triplets = findFeiji(selected.filter(c => !usedIndex.has(c)));
          ...
          const bombs = findBombsWithHeartCard(selected.filter(c => !usedIndex.has(c)));
          ...
          const straights = findStraightByCard(selected.filter(c => !usedIndex.has(c)));
          ...
          const lianduiGroups = findLiandui(selected.filter(c => !usedIndex.has(c)));
          ...
          if (selected.length == 2 || selected.length == 3) {
            const unusedCards = selected.filter(c => !usedIndex.has(c));
...
//# sourceMappingURL=33abe49b4b1d3cb6a745e055e8f2f50313c35b8d.js.map