    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getHintCards(targetCards, groupedCards) {
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              const result = tryMergeBomb(groupedCards);
        ...
        function tryMergeBomb(grouped) {
          // 合并所有小组为一个大数组
          const merged = grouped.flat(); // 调用已有的支持红心级牌的炸弹检测方法

          const bombs = GameLogic.newfindBombs(merged); // 如果找到合法炸弹，返回第一组
...
//# sourceMappingURL=c51a6ad0cbe69c83b6d146cabca82a02aedd212b.js.map