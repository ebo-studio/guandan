    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function autoSortCards(cards) {
          const result = [];
          const used = new Set(); // 🔥 先处理王炸、N炸、同花顺等大牌（按固定顺序）
          ...
          const shuffledTypes = shuffleArray([findFeiji, findLiandui, findStraightByCard, findThreeWithTwo]);

          for (let findFn of shuffledTypes) {
...
//# sourceMappingURL=c7bb7a408d728a22cbdc8ea09679143d3b2a57d6.js.map