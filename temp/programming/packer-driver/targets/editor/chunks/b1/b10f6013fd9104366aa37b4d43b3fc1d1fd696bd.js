    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected) {
          let selectedCopy = (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
            error: Error()
          ...
          for (let i = 0; i < cards.length; i++) {
            const v = cards[i];
            const index = selectedCopy.indexOf(v);
...
//# sourceMappingURL=b10f6013fd9104366aa37b4d43b3fc1d1fd696bd.js.map