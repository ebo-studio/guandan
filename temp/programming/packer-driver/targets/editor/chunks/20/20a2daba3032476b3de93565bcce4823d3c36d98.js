      ...
      (function (_GameLogic) {
        ...
        function groupByPoint(cards) {
          ...
          for (let card of cards) {
            const point = this.getCardPoint(card);
        ...
        function extractGroups(cards, count) {
          ...
          map.array.forEach(element => {
            if (element.length >= count) {
              groups.push(element.slice(0, count));
            }
          });
          groups.sort((a, b) => this.getCardPoint(b[0]) - this.getCardPoint(a[0]));
          return groups;
        }
...
//# sourceMappingURL=20a2daba3032476b3de93565bcce4823d3c36d98.js.map