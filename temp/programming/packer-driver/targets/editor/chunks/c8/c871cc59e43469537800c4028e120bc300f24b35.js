    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        setHandCards(value, ani = false, isUp = false, isOneCard = false) {
          ...
          const test = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            error: Error()
          }), GameLogic) : GameLogic).findFlushStraightsWithHeartWildcard(this.handCardsValue);
          console.log('有什么同花顺>>', test);
        ...
        dealOutCards(viewid, cardList, count, isAuto = true) {
          ...
          if (viewid == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            console.log("出牌前 groupedCards: ", (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
            }), utils) : utils).deepCopy(this.groupedCards));
            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                ...
                if (isAuto) {
                  ...
                  sameSizeList = this.groupedCards; // GlobalData.cardInfo.sortCard = false;
                } else {
                  this.groupedCards = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                    error: Error()
                  }), GameLogic) : GameLogic).removeOutCardsFromGrouped(this.groupedCards, tempCards);
            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              const hintList = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
          ...
          for (let i = this.handCards.length - 1; i >= 0; i--) {
            ...
            if (item != null) {
              ...
              if (leftUp || leftDown || rightUp || rightDown) {
                ...
                const card = this.handCards[i]; // const rect = this.getCardRect(card);
        ...
        isPointInRect(localMovePos, card) {
          ...
          const halfH = size.height * 0.5; // 卡牌在父节点下的边界

          const rect = new Rect(pos.x - halfW, pos.y - halfH, size.width, size.height);
        ...
        onBtnHint() {
          ...
          if ((this.outCardList.length == 1 || this.outCardList.length == 3) && ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            let netHint = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
              error: Error()
...
//# sourceMappingURL=c871cc59e43469537800c4028e120bc300f24b35.js.map