    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        init(reset = true) {
          ...
          this.testSelfHandCard(); // this.testOtherOuts();
        ...
        testSelfHandCard() {
          ...
          function generateRandomDeck() {
            const deck = []; // 红心级牌：♥2（color = 1, rank = 2）=> 1 * 16 + 2 = 0x12

            const heartLevel2 = 1 * 16 + 2; // = 18 (0x12)
            // 普通牌（不包含红心2）

            for (let color = 0; color < 4; color++) {
              for (let rank = 1; rank <= 13; rank++) {
                const card = color * 16 + rank;
                if (card === heartLevel2) continue; // 跳过红心2
          ...
          const handCards = fullDeck.slice(0, 27); // 取前27张作为玩家手牌

          console.log(handCards);
          this.setHandCards(handCards, true);
...
//# sourceMappingURL=77d09c6b341ca432d57dff00724b38cecddf7813.js.map