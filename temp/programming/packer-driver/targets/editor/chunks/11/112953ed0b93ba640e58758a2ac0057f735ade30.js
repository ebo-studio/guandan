    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function findStraightByCard(cards) {
          ...
          const allRanks = Array.from(map.keys()).filter(r => r >= 3 && r <= 14) // 排除 2 和大小王
          .sort((a, b) => a - b);
          const results = [];
          let temp = [];

          for (let i = 0; i < allRanks.length; i++) {
            const rank = allRanks[i]; // 连续则继续，不连续则重置 temp
...
//# sourceMappingURL=112953ed0b93ba640e58758a2ac0057f735ade30.js.map