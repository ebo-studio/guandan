System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "79046PSAtRPTLEWvicfOxqT", "RankRaceAuditionLineItem", undefined);
      ...
      _export("RankRaceAuditionLineItem", RankRaceAuditionLineItem = (_dec = ccclass('RankRaceAuditionLineItem'), _dec2 = property(_crd && LobbyUserHeadItem === void 0 ? (_reportPossibleCrUseOfLobbyUserHeadItem({
        error: Error()
      }), LobbyUserHeadItem) : LobbyUserHeadItem), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class RankRaceAuditionLineItem extends (_crd && AItemRenderer === void 0 ? (_reportPossibleCrUseOfAItemRenderer({
        error: Error()
        ...
        onBtnDetailClick() {
          ...
          (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).requestAuditionUpList(this.data.game_id, {
            success: () => {
              (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
                ...
                path: (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
                  error: Error()
                }), UIConfig) : UIConfig).RankAuditionItemKey
              });
            }
          });
        }
...
//# sourceMappingURL=9932d7365023032c6c8b8cd74f220673cced9c29.js.map