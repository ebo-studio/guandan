    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function autoSortCards(cards) {
          ...
          function addGroup(groups, toResult = true) {
          ...
          const getRemain = () => cards.filter(c => !used.has(c)); // ✅ 固定牌型优先处理
          ...
          const feiji = shuffleArray(findFeiji(getRemain()));
          const liandui = shuffleArray(findLiandui(getRemain()));
          const shunzi = shuffleArray(findStraightByCard(getRemain()));
          const sanzhang = shuffleArray(findThreeWithTwo(getRemain()));
...
//# sourceMappingURL=ec605e4303e266bd61d093907dbf6ef5d80f9980.js.map