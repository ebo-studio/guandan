        ...
        setHandCards(value, ani = false, isUp = false) {
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            let sameSizeList = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
              error: Error()
            }), GameLogic) : GameLogic).getSameCardSizeList(this.handCardsValue); // console.log("sameSizeList--> ",sameSizeList.length);
...
//# sourceMappingURL=c424564f83b7baf9b9026d4f4f0e44a68d257f88.js.map