System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, GlobalData, GameLogic, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, CardItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CardItem", CardItem = (_dec = ccclass('CardItem'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Sprite), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class CardItem extends Component {
        constructor(...args) {
          super(...args);
...
//# sourceMappingURL=3b85de9ff0d5ffa309f3976a155fd9e7d60c09aa.js.map