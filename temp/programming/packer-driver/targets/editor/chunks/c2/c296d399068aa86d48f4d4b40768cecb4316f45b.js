    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getRemainCardsByDelete(value, deleteCards, keepOrder = false, select = [], prevSelected = []) {
          ...
          const remainCards = [];
          const deleteIdx = [];
          const sameSizeList = GameLogic.getSameCardSizeList(value, keepOrder);
          const flatList = [];
          ...
          const usedSet = new Set(); // 标记已经删除的牌（精确牌值）
...
//# sourceMappingURL=c296d399068aa86d48f4d4b40768cecb4316f45b.js.map