    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function smartSortCards(cards) {
          ...
          const levelRank = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          ...
          restGroups.sort((a, b) => {
            const maxA = Math.max(...a.map(c => c % 16));
            const maxB = Math.max(...b.map(c => c % 16));
            return maxB - maxA;
...
//# sourceMappingURL=955f023a4d8900f0934213433f1b2fffa139038e.js.map