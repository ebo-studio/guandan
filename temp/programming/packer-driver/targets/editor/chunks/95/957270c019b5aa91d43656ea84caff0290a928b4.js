    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getOneCardSizeList(value) {
          ...
          const remainingPairs = pairs.filter(pair => !usedPairs.has(pair[0])); // ➕ 顺子 / 同花顺识别
          ...
          const remainSingleList = remainAfterStraight.map(c => [c]); // 合并结果

          const tmpAll = [...tongHuaShunList, ...lianDuiList, ...shunziList, ...remainingPairs, ...otherGroups, ...remainSingleList];
        ...
        function getGroupPower(cards) {
          ...
          const allSame = cards.every(c => getCardSize(c) === getCardSize(cards[0])); // 四王炸
...
//# sourceMappingURL=957270c019b5aa91d43656ea84caff0290a928b4.js.map