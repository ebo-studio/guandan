    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          const remaining = cards.filter((_, idx) => !usedIndex.has(idx)); // const remaining = cards.filter(card => !usedCards.has(card));
...
//# sourceMappingURL=413339e8c13159ec4781ac1cef901103980febd8.js.map