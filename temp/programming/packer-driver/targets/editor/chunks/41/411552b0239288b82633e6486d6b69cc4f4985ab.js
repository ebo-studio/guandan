            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              if (isAuto) {
                ...
                console.log("出牌后 groupedCards: ", (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
                  error: Error()
                }), utils) : utils).deepCopy(this.groupedCards)); // 保险：核对分组总牌数，若不匹配则强制重跑智能理牌

                const groupedCnt = this.groupedCards.reduce((s, g) => s + g.length, 0);

                if (groupedCnt !== this.handCardsValue.length) {
...
//# sourceMappingURL=411552b0239288b82633e6486d6b69cc4f4985ab.js.map