    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        showUI(obj) {
          ...
          let info = (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            error: Error()
          ...
          resources.load(info.path, Prefab, (err, res) => {
            ...
            let com = (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
        ...
        getUI(uiName) {
          let item = this.uiMap.get(uiName);
          return item;
        }
...
//# sourceMappingURL=dc5ee015b4ad7a0c542d8dcb9b947268c1be0f23.js.map