        ...
        setHandCards(value, ani = false, isUp = false, isOneCard = false) {
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              this.initHandStartPosX_V(groupList.length);
              ...
              for (let i = 0; i < groupList.length; i++) {
                ...
                for (let j = list.length - 1; j >= 0; j--) {
                  ...
                  const posY = this.getHandCardPosY_V(list.length - 1 - j);
                  ...
                  if (ani && i === groupList.length - 1 && j === 0) {
                    card.setBack(true);
                  }
                  ...
                  card.setIndex(idx);
                  card.setBottom(j === 0);
                  card.setLastLine(i === groupList.length - 1);
                  idx++;
                  this.handCards.push(card);
                }
              }
...
//# sourceMappingURL=65f4b617ae4b9ef58de3a9031aed6d29a0e8102c.js.map