      ...
      _export("RaceAuditionItem", RaceAuditionItem = (_dec = ccclass('RaceAuditionItem'), _dec2 = property(_crd && AVirtualScrollView === void 0 ? (_reportPossibleCrUseOfAVirtualScrollView({
        ...
        startTime() {
          ...
          this.timeFunc = () => {
            for (let i = 0; i < listData.length; i++) {
              let item = listData[i]; //开始前   开始剩余倒计时
        ...
        changeState(data) {
          ...
          for (let i = 0; i < childs.length; i++) {
            let element = childs[i].getComponent(_crd && RaceAuditionLineItem === void 0 ? (_reportPossibleCrUseOfRaceAuditionLineItem({
              error: Error()
...
//# sourceMappingURL=2e3bec86ad952f8e4429cc9c5f3472fa2bff73cc.js.map