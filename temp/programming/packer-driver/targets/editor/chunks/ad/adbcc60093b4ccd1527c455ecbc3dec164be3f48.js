    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        setHandCards(value, ani = false, isUp = false, isOneCard = false) {
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              let that = this;
              let idx = 0;
              this.initHandStartPosX_V(value.length);
              ...
              for (let i = 0; i < value.length; i++) {
                ...
                let posY = this.getHandCardPosY_V(0); // 每列纵向，只显示一张

                card.node.scale = new Vec3(this.handScale, this.handScale, this.handScale);
                let cardSps = this.getCardsSprite(value1);
                ...
                if (ani && i == value.length - 1) {
                  card.setBack(true);
                }

                const moveFunc = function (posX, posY, tmpIdx) {
                  if (ani) {
                    card.node.setPosition(v3(0, 0, 0));
                    tween(card.node).delay(i * delayTime).call(() => {
                      if (tmpIdx == idx - 1) {
                ...
                card.setLastLine(i == value.length - 1);
                this.handCards.push(card);
                idx++;
              }
            } else {
              this.handCardsValue = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).sortCardsBySizeDown(this.handCardsValue, this.handCardsValue.length); // console.log("len---> ",value.length);
        ...
        dealOutCards(viewid, cardList, count, isAuto = true) {
          ...
          if (viewid == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              //整理手牌
              let posY = this.getHandCardPosY(); //实际起始位置
              ...
              for (let j = 0; j < this.handCards.length; j++) {
                ...
                card.setIndex(j); //手牌位置

                let posX = this.getHandCardPosX(j);

                let moveFunc = function (posX, tmpIdx) {
              ...
              if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                ...
                sameSizeList = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                  error: Error()
                }), GameLogic) : GameLogic).getOneCardSizeList(this.handCardsValue);
              } else {
                sameSizeList = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                  error: Error()
        ...
        onBtnCardDir() {
          ...
          const remain = (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
            error: Error()
          }), utils) : utils).deepCopy(this.handCardsValue);
          const selectCopy = (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
            error: Error()
...
//# sourceMappingURL=adbcc60093b4ccd1527c455ecbc3dec164be3f48.js.map