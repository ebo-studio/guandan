    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function smartSortCards(cards) {
          ...
          var countMap = this.getCardCountMap(cards);
          var flushStraights = this.findFlushStraight(getUnused());
          flushStraights.forEach(pushAndMark); // 1. 炸弹（4张或更多）
          ...
          pairs.forEach(pushAndMark); // 7. 单张
...
//# sourceMappingURL=6134560fed1a8b2ab9434a6bc11efbd989b94c77.js.map