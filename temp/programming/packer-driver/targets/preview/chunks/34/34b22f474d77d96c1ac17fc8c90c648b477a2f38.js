System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, AVirtualScrollView, GlobalData, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, RankRaceAuditionItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4c387f792NE6qCcV+bJfGxo", "RankRaceAuditionItem", undefined);
      ...
      _export("RankRaceAuditionItem", RankRaceAuditionItem = (_dec = ccclass('RankRaceAuditionItem'), _dec2 = property(_crd && AVirtualScrollView === void 0 ? (_reportPossibleCrUseOfAVirtualScrollView({
        error: Error()
      }), AVirtualScrollView) : AVirtualScrollView), _dec3 = property(Node), _dec(_class = (_class2 = class RankRaceAuditionItem extends Component {
        constructor() {
          super(...arguments);
        ...
        setData() {
          this.nodeTip.active = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).gameResultInfo.auditionList.length == 0;
          ...
          if (this.personScroll.node.active) {
            this.personScroll.refreshData((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).gameResultInfo.auditionList);
          }
        }
...
//# sourceMappingURL=34b22f474d77d96c1ac17fc8c90c648b477a2f38.js.map