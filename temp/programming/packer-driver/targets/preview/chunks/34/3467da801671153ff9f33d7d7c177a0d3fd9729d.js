    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function autoSortCards(cards) {
          ...
          addGroup(findPair(cards.filter(c => !used.has(c))));
          addGroup(findAllSingles(cards.filter(c => !used.has(c)))); // ✅ 随机组合（每次点击可能结果不同）

          var remain = cards.filter(c => !used.has(c));
          var restGroups = [];
          restGroups.push(...findFeiji(remain));
          restGroups.push(...findLiandui(remain));
          restGroups.push(...findStraightByCard(remain));
          restGroups.push(...findThreeWithTwo(remain));
          shuffleArray(restGroups); // 每次乱序
...
//# sourceMappingURL=3467da801671153ff9f33d7d7c177a0d3fd9729d.js.map