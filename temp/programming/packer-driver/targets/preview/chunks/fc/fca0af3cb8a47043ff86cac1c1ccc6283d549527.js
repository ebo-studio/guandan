            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i14 = groupedCards.length - 1; _i14 >= 0; _i14--) {
                ...
                if (_group9.length >= 4) {
                  var _ret2 = function () {
                    // ✅ 点数必须全部一致，才是炸弹
                    var rank = _group9[0] % 16;

                    var isBomb = _group9.every(card => card % 16 === rank);

                    if (!isBomb) return "continue";
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i16 = groupedCards.length - 1; _i16 >= 0; _i16--) {
                ...
                if (_group11.length >= 6) {
                  var groupRank = GameLogic.getCardSize(_group11[0]);
...
//# sourceMappingURL=fca0af3cb8a47043ff86cac1c1ccc6283d549527.js.map