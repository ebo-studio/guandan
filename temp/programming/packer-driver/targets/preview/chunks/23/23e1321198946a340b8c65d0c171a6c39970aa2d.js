        ...
        function getHintCards(targetCards, groupedCards) {
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i19 = sameShunzi.length - 1; _i19 >= 0; _i19--) {
                var _group13 = sameShunzi[_i19];
              ...
              for (var _i20 = groupedCards.length - 1; _i20 >= 0; _i20--) {
                ...
                if (_group14.length == 4) {
                  var _bombs = GameLogic.findRocket(_group14);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i23 = groupedCards.length - 1; _i23 >= 0; _i23--) {
                ...
                if (_group17.length == 4) {
                  var _bombs2 = GameLogic.newfindBombs(_group17);
              ...
              for (var _i24 = result1.length - 1; _i24 >= 0; _i24--) {
                var _group18 = result1[_i24]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);

                if (_group18.length != 0) {
              ...
              for (var _i25 = sameShunzi1.length - 1; _i25 >= 0; _i25--) {
                var _group19 = sameShunzi1[_i25];
              ...
              for (var _i26 = groupedCards.length - 1; _i26 >= 0; _i26--) {
                ...
                if (_group20.length == 4) {
                  var _bombs3 = GameLogic.findRocket(_group20);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i27 = groupedCards.length - 1; _i27 >= 0; _i27--) {
                  ...
                  if (_group21.length === 3) {
                    var size = GameLogic.getCardSize(_group21[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i29 = groupedCards.length - 1; _i29 >= 0; _i29--) {
                ...
                if (_group22.length >= 4) {
                  // ✅ 点数必须全部一致，才是炸弹
                  var isBomb = isSamePointWithFrp(_group22, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    error: Error()
                  }), GlobalData) : GlobalData).cardInfo.levelCard);
                  if (!isBomb) continue;
                  var groupRank = GameLogic.getCardSize(_group22[0]);

                  if (_group22.length > targetCards.length || _group22.length === targetCards.length && groupRank > targetMainSize) {
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i30 = 0; _i30 <= sizes.length - 5; _i30++) {
                  var ok = true;

                  for (var _j2 = 1; _j2 < 5; _j2++) {
                    if (sizes[_i30 + _j2] !== sizes[_i30 + _j2 - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
                  ...
                  if (ok) {
                    ...
                    for (var _j3 = 0; _j3 < 5; _j3++) {
                      var _s = sizes[_i30 + _j3];
                      var list = sizeMap.get(_s);

                      _group23.push(list.pop()); // 拿一张即可
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i31 = groupedCards.length - 1; _i31 >= 0; _i31--) {
                ...
                if (_group24.length >= 6) {
                  if (!isSamePointWithFrp(_group24, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    error: Error()
                  }), GlobalData) : GlobalData).cardInfo.levelCard)) continue;

                  var _groupRank = GameLogic.getCardSize(_group24[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop4 = function _loop4(_i32) {
                  var seq = allRanks.slice(_i32, _i32 + targetLength);
                  ...
                  if (isContinuous && seq[0] > targetStart) {
                    ...
                    for (var r of seq) {
                      _group25.push(rankMap.get(r).pop());
                    }
                ...
                for (var _i32 = 0; _i32 <= allRanks.length - targetLength; _i32++) {
                  var _ret4 = _loop4(_i32);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop5 = function _loop5(_i33) {
                  var seq = _allRanks.slice(_i33, _i33 + _targetLength);
                  ...
                  if (isContinuous && seq[0] > _targetStart) {
                    ...
                    for (var r of seq) {
                      _group26.push(_rankMap.get(r).pop());
                    }
                ...
                for (var _i33 = 0; _i33 <= _allRanks.length - _targetLength; _i33++) {
                  var _ret5 = _loop5(_i33);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i34 = 0; _i34 <= tripletGroups.length - _targetLength2 / 3; _i34++) {
                  var _group27 = [];
                  var _ok = true;

                  for (var _j4 = 0; _j4 < _targetLength2 / 3; _j4++) {
                    var cur = tripletGroups[_i34 + _j4];

                    if (_j4 > 0 && cur.rank !== tripletGroups[_i34 + _j4 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }

                    _group27.push(...cur.cards);
                  }

                  if (_ok && tripletGroups[_i34].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i35 = 0; _i35 <= pairGroups.length - _targetLength3 / 2; _i35++) {
                  var _group28 = [];
                  var _ok2 = true;

                  for (var _j5 = 0; _j5 < _targetLength3 / 2; _j5++) {
                    var _cur = pairGroups[_i35 + _j5];

                    if (_j5 > 0 && _cur.rank !== pairGroups[_i35 + _j5 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }

                    _group28.push(..._cur.cards);
                  }

                  if (_ok2 && pairGroups[_i35].rank > _targetMin) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i37 = groupedCards.length - 1; _i37 >= 0; _i37--) {
                ...
                if (_group30.length === 3) {
                  var _card10 = _group30[0];
            ...
            if (hintList.length === 0) {
              for (var _i38 = groupedCards.length - 1; _i38 >= 0; _i38--) {
                ...
                if (_group31.length >= 4) {
                  var bombs = GameLogic.newfindBombs(_group31);
            ...
            for (var _group32 of groupedCards) {
              if (_group32.length === 2 && GameLogic.getCardSize(_group32[0]) > targetRank) {
            ...
            for (var _group33 of groupedCards) {
              if (_group33.length === 3 && GameLogic.getCardSize(_group33[0]) > targetRank) {
            ...
            var _loop6 = function _loop6(_group34) {
              if (_group34.length === 3 && GameLogic.getCardSize(_group34[0]) > targetRank) {
                // 找一个对子作为带牌
                var pair = groupedCards.find(g => g.length === 2 && g !== _group34);

                if (pair) {
                  hintList.push([..._group34, ...pair]);
                }
              }
            };
        ...
        function findFlushStraightWithHeart(groups) {
          ...
          for (var [_color2, cards] of colorMap.entries()) {
            ...
            for (var _card11 of cards) {
              ...
              rankToCards.get(rank).push(_card11);
            }
            ...
            var _loop7 = function _loop7(seq) {
              ...
              if (valid) {
                result.push(group);
                return "break"; // 找到一组即返回，如需多组可移除 break
              }
            };

            for (var seq of seqList) {
              var _ret6 = _loop7(seq);
...
//# sourceMappingURL=23e1321198946a340b8c65d0c171a6c39970aa2d.js.map