    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getRemainCardsByDelete(value, deleteCards) {
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              sameSizeList = GameLogic.getOneCardSizeList(this.handCardsValue);
            } else {
        ...
        function moveSelectedCardsToBack(cards, selected) {
          ...
          for (var _i6 = 0; _i6 < remain.length; _i6++) {
            var cur = remain[_i6];
...
//# sourceMappingURL=2387b228979d0ae55994f25d2afc48ef25b03d4a.js.map