    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        updateSelectedCards_V() {
          ...
          var isRecover = this.isSelectedFromSortedGroup(this.handCardsValue, this.sorthandCardsValue, this.selectCardValue);
        ...
        isSelectedFromSortedGroup(cards, sorthandCardsValue, selected) {
          ...
          for (var val of sorthandCardsValue) {
          ...
          for (var _val of selected) {
            selectedCount.set(_val, (selectedCount.get(_val) || 0) + 1);
          }

          for (var _i3 = cards.length - 1; _i3 >= 0; _i3--) {
            var _c = cards[_i3];

            if ((selectedCount.get(_c) || 0) > 0) {
              if (used.has(_i3)) return true; // 命中了理牌中那张牌

              selectedCount.set(_c, selectedCount.get(_c) - 1);
            }
          }
...
//# sourceMappingURL=b0f468e062c8734cab865c9b97548ef7fc5d486a.js.map