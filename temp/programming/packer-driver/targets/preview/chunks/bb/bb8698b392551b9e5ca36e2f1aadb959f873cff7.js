      ...
      (function (_GameLogic) {
        ...
        function findStraightByCard(cards) {
          ...
          for (var i = 0; i < cards.length; i++) {
            ...
            rankMap.get(rank).push(i); // 存 index
          }
          ...
          for (var seq of seqList) {
            ...
            for (var r of seq) {
              ...
              if (r === 2) {
                for (var _i7 = 0; _i7 < cards.length; _i7++) {
                  if (getCardRank(cards[_i7]) === 2 && getCardColor(cards[_i7]) === HONGTAO && !usedIndex.has(_i7)) {
                    foundIdx = _i7;
                    break;
                  }
                }
              } else {
                var candidateIdxList = rankMap.get(r);
                ...
                for (var _i8 of candidateIdxList) {
                  if (!usedIndex.has(_i8)) {
                    foundIdx = _i8;
                    break;
                  }
                }
              ...
              groupIndexes.push(foundIdx);
            }

            if (valid) {
              var groupCards = groupIndexes.map(i => cards[i]);
              results.push(groupCards);
              groupIndexes.forEach(i => usedIndex.add(i));
              break; // 只找一组
            }
          }
            ...
            for (var start = 3; start <= 10; start++) {
              ...
              if (missing === 0) {
                ...
                if (frp !== undefined) {
                  ...
                  // 恢复
                  for (var [_r, _c2] of tempPopped) {
                    if (!rankMap.has(_r)) rankMap.set(_r, []);
                    rankMap.get(_r).push(_c2);
                  }
                }
              } else {
                // 恢复
                for (var [_r2, _c3] of tempPopped) {
                  if (!rankMap.has(_r2)) rankMap.set(_r2, []);
                  rankMap.get(_r2).push(_c3);
                }
              }
            }
          }
          ...
          while (i <= ranks.length - 5) {
            ...
            if (length == 5) {
              ...
              for (var _rank3 of seq) {
                var cardsOfRank = map.get(_rank3);
          ...
          while (i <= sortedRanks.length - 5) {
            ...
            if (isConsecutive) {
              ...
              for (var _rank4 of seq) {
                var available = rankMap.get(_rank4).filter(idx => !usedIndex.has(idx));
        ...
        function countThreeWithTwoAndStraight(unused) {
          ...
          for (var _i13 = 0; _i13 < unused.length; _i13++) {
            var _rank5 = getCardSize(unused[_i13]);

            if (_rank5 >= 3 && _rank5 <= 14 && !usedIndex.has(_i13)) {
              if (!rankToIndexes.has(_rank5)) rankToIndexes.set(_rank5, []);
              rankToIndexes.get(_rank5).push(_i13);
            }
          }
        ...
        function findStraight(cards) {
          ...
          while (i <= ranks.length - 5) {
            ...
            if (length == 5) {
              ...
              for (var _rank6 of seq) {
                var cardsOfRank = map.get(_rank6);
                straight.push(cardsOfRank.pop());
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i18 = groupedCards.length - 1; _i18 >= 0; _i18--) {
                var _group7 = groupedCards[_i18];

                if (_group7.length == 5) {
                  var _bombs = GameLogic.newfindBombs(_group7);
              ...
              for (var _i19 = groupedCards.length - 1; _i19 >= 0; _i19--) {
                var _group8 = groupedCards[_i19];

                if (_group8.length == 5) {
                  var _bombs2 = GameLogic.findFlushStraight(_group8);
              ...
              for (var _i20 = groupedCards.length - 1; _i20 >= 0; _i20--) {
                var _group9 = groupedCards[_i20];

                if (_group9.length == 6) {
                  var _bombs3 = GameLogic.newfindBombs(_group9);
              ...
              for (var _i21 = groupedCards.length - 1; _i21 >= 0; _i21--) {
                ...
                if (_group10.length == 4) {
                  var _bombs4 = GameLogic.findRocket(_group10);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i23 = groupedCards.length - 1; _i23 >= 0; _i23--) {
                ...
                if (_group12.length === 3) {
                  var _card6 = _group12[0];
              ...
              for (var _i24 = groupedCards.length - 1; _i24 >= 0; _i24--) {
                var _group13 = groupedCards[_i24];

                if (_group13.length == 4) {
                  var _bombs5 = GameLogic.newfindBombs(_group13);
              ...
              for (var _i25 = groupedCards.length - 1; _i25 >= 0; _i25--) {
                var _group14 = groupedCards[_i25];

                if (_group14.length == 5) {
                  var _bombs6 = GameLogic.newfindBombs(_group14);
              ...
              for (var _i26 = groupedCards.length - 1; _i26 >= 0; _i26--) {
                var _group15 = groupedCards[_i26];

                if (_group15.length == 5) {
                  var _bombs7 = GameLogic.findFlushStraight(_group15);
              ...
              for (var _i27 = groupedCards.length - 1; _i27 >= 0; _i27--) {
                ...
                if (_group16.length == 6) {
                  var _bombs8 = GameLogic.newfindBombs(_group16);
              ...
              for (var _i28 = groupedCards.length - 1; _i28 >= 0; _i28--) {
                ...
                if (_group17.length == 4) {
                  var _bombs9 = GameLogic.findRocket(_group17);
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i29 = groupedCards.length - 1; _i29 >= 0; _i29--) {
                  ...
                  if (_group18.length === 3) {
                    var size = GameLogic.getCardSize(_group18[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i31 = groupedCards.length - 1; _i31 >= 0; _i31--) {
                var _group19 = groupedCards[_i31];

                if (_group19.length >= 4) {
                  // ✅ 点数必须全部一致，才是炸弹
                  var isBomb = isSamePointWithFrp(_group19, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    error: Error()
                  }), GlobalData) : GlobalData).cardInfo.levelCard);
                  if (!isBomb) continue;
                  var groupRank = GameLogic.getCardSize(_group19[0]);

                  if (_group19.length > targetCards.length || _group19.length === targetCards.length && groupRank > targetMainSize) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i33 = groupedCards.length - 1; _i33 >= 0; _i33--) {
                var _group21 = groupedCards[_i33];

                if (_group21.length >= 6) {
                  if (!isSamePointWithFrp(_group21, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    error: Error()
                  }), GlobalData) : GlobalData).cardInfo.levelCard)) continue;

                  var _groupRank = GameLogic.getCardSize(_group21[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop2 = function _loop2(_i34) {
                  ...
                  if (isContinuous && seq[0] > targetStart) {
                    ...
                    for (var r of seq) {
                      _group22.push(rankMap.get(r).pop());
                    }
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop3 = function _loop3(_i35) {
                  ...
                  if (isContinuous && seq[0] > _targetStart) {
                    ...
                    for (var r of seq) {
                      _group23.push(_rankMap.get(r).pop());
                    }
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i38 = groupedCards.length - 1; _i38 >= 0; _i38--) {
                var _group26 = groupedCards[_i38];

                if (_group26.length === 2) {
                  var card = _group26[0];
            ...
            if (hintList.length === 0) {
              for (var _i39 = groupedCards.length - 1; _i39 >= 0; _i39--) {
                ...
                if (_group27.length === 3) {
                  var _card10 = _group27[0];
            ...
            if (hintList.length === 0) {
              for (var _i40 = groupedCards.length - 1; _i40 >= 0; _i40--) {
                var _group28 = groupedCards[_i40];

                if (_group28.length >= 4) {
                  var bombs = GameLogic.newfindBombs(_group28);
            ...
            for (var _group29 of groupedCards) {
              if (_group29.length === 2 && GameLogic.getCardSize(_group29[0]) > targetRank) {
            ...
            for (var _group30 of groupedCards) {
              if (_group30.length === 3 && GameLogic.getCardSize(_group30[0]) > targetRank) {
            ...
            var _loop4 = function _loop4(_group31) {
              if (_group31.length === 3 && GameLogic.getCardSize(_group31[0]) > targetRank) {
                // 找一个对子作为带牌
                var pair = groupedCards.find(g => g.length === 2 && g !== _group31);

                if (pair) {
                  hintList.push([..._group31, ...pair]);
                }
              }
            };

            for (var _group31 of groupedCards) {
              _loop4(_group31);
            }
          } // // ------------------ 顺子 ------------------
...
//# sourceMappingURL=bb8698b392551b9e5ca36e2f1aadb959f873cff7.js.map