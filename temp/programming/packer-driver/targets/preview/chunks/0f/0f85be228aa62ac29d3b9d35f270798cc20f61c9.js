    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function findThreeWithTwo(cards) {
          ...
          var _loop = function _loop(triple) {
            ...
            for (var list of pairMap.values()) {
              var _rank2 = getCardSize(list[0]);

              if (_rank2 < 3 || _rank2 > 14) continue;
        ...
        function smartSortCards(cards) {
          ...
          findThreeWith(getUnused()).forEach(g => pushAndMark(g, false));
...
//# sourceMappingURL=0f85be228aa62ac29d3b9d35f270798cc20f61c9.js.map