      ...
      _export("RaceScoreItem", RaceScoreItem = (_dec = ccclass('RaceScoreItem'), _dec2 = property(_crd && AVirtualScrollView === void 0 ? (_reportPossibleCrUseOfAVirtualScrollView({
        ...
        changeState(data, updateState, updateTime, updateTimeState) {
          ...
          for (var i = 0; i < childs.length; i++) {
            var element = childs[i].getComponent(_crd && RaceScoreLineItem === void 0 ? (_reportPossibleCrUseOfRaceScoreLineItem({
              error: Error()
...
//# sourceMappingURL=843a30af08822f4a4fc3ecade06f9ccf9ae9c69a.js.map