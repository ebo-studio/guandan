    ...
    execute: function () {
      ...
      (function (_event) {
        ...
        function register_event(name, target, func) {
          ...
          var array = event_map.has(name) ? event_map.get(name) : [];
        ...
        function unregister_event(name, target, func) {
          if (func === void 0) {
            func = null;
          }
...
//# sourceMappingURL=0430a400e85d24a70cac04e5afa8e863a1e4ab76.js.map