    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function smartSortCards(cards) {
          ...
          console.log('順子數量>>>', straightList.length); // var straightList = findStraight_II(cards, usedIndex);

          var threeWithList = findThreeWithTwoBy(getUnused());
          console.log('三帶二', threeWithList.length);
          ...
          switch (type) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i26 = 0; _i26 <= sizes.length - 5; _i26++) {
                  var ok = true;

                  for (var _j2 = 1; _j2 < 5; _j2++) {
                    if (sizes[_i26 + _j2] !== sizes[_i26 + _j2 - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop2 = function _loop2(_i28) {
                  var seq = allRanks.slice(_i28, _i28 + targetLength);
                ...
                for (var _i28 = 0; _i28 <= allRanks.length - targetLength; _i28++) {
                  var _ret = _loop2(_i28);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop3 = function _loop3(_i29) {
                  var seq = _allRanks.slice(_i29, _i29 + _targetLength);
                ...
                for (var _i29 = 0; _i29 <= _allRanks.length - _targetLength; _i29++) {
                  var _ret2 = _loop3(_i29);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i30 = 0; _i30 <= tripletGroups.length - _targetLength2 / 3; _i30++) {
                  var _group24 = [];
                  var _ok = true;

                  for (var _j4 = 0; _j4 < _targetLength2 / 3; _j4++) {
                    var cur = tripletGroups[_i30 + _j4];

                    if (_j4 > 0 && cur.rank !== tripletGroups[_i30 + _j4 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }
                  ...
                  if (_ok && tripletGroups[_i30].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i31 = 0; _i31 <= pairGroups.length - _targetLength3 / 2; _i31++) {
                  var _group25 = [];
                  var _ok2 = true;

                  for (var _j5 = 0; _j5 < _targetLength3 / 2; _j5++) {
                    var _cur = pairGroups[_i31 + _j5];

                    if (_j5 > 0 && _cur.rank !== pairGroups[_i31 + _j5 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }
                  ...
                  if (_ok2 && pairGroups[_i31].rank > _targetMin) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i34 = groupedCards.length - 1; _i34 >= 0; _i34--) {
                var _group28 = groupedCards[_i34];
...
//# sourceMappingURL=138340898945b6536ffa7209a8693da5137ef777.js.map