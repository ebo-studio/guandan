      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(_crd && UserHead === void 0 ? (_reportPossibleCrUseOfUserHead({
        ...
        preLoad() {
          ...
          (_Instace = (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
          }), UIManager) : UIManager).Instace) == null ? void 0 : _Instace.clearAllUI();
        ...
        onKangGong(init, id1, id2) {
          if (init) {
            for (var i = 0; i < this.nodeNoCards.length; i++) {
        ...
        onUserList(data) {
          ...
          var tmpList = (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
            error: Error()
          }), utils) : utils).deepCopy(this.viewList);

          for (var j = 0; j < data.list.length; j++) {
            var _element = data.list[j];
            var viewId = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
              error: Error()
            }), GameLogic) : GameLogic).switchChairIdToViewId(_element.index);
            this.updateUserHeadByViewId(viewId, {
              head: _element.headImg,
              name: _element.name,
              score: _element.gold
            });
        ...
        startGame() {
          ...
          var sendBuffer = (_instance = (_crd && PbManager === void 0 ? (_reportPossibleCrUseOfPbManager({
            error: Error()
        ...
        initSetDown() {
          for (var i = 0; i < this.nodeSetDowns.length; i++) {
            var element = this.nodeSetDowns[i];
        ...
        initUserPosition() {
          ...
          for (var i = 0; i < this.userHeads.length; i++) {
            var e = this.userHeads[i];
        ...
        updateUserHeadByViewId(viewId, data) {
          ...
          var type = viewId == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
        ...
        setCardLevel(show) {
          ...
          if (show) {
            var cardNum = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).cardInfo.levelCard;
            var key = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
        ...
        onBtSetDownClick(touch, index) {
          ...
          var tmpIdx = null;
          var selfIdx = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            error: Error()
          ...
          (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            ...
            data: {
              ...
              des: "确定下坐吗?",
              okFunc: () => {
                var baseInfo = GameMsg.User.create({
                  index: Number(tmpIdx)
                });
                var baseBuffer = GameMsg.User.encode(baseInfo).finish();
                var sendBuffer = (_crd && PbManager === void 0 ? (_reportPossibleCrUseOfPbManager({
                  error: Error()
                }), PbManager) : PbManager).instance.sendMsg((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                  error: Error()
...
//# sourceMappingURL=d53cc27e283e52222f0f50b4597a8b6da68ca283.js.map