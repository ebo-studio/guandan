    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        onBtnCardDir() {
          ...
          var result = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            error: Error()
          }), GameLogic) : GameLogic).getRemainCardsByDelete(this.handCardsValue, selected);
          var remainCards = result.cards;
          var sortedGroup = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            error: Error()
          }), GameLogic) : GameLogic).getSortCard(selected);
          this.handCardsValue = remainCards.concat(sortedGroup);
          this.setHandCards(this.handCardsValue); // 清除弹起状态和选择
...
//# sourceMappingURL=5200a2d5c06230784855fb54f95d40755c6bcbc6.js.map