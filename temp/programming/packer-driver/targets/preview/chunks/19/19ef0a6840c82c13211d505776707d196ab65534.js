      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        setHandCards(value, ani, isUp, isOneCard) {
          ...
          if (isOneCard) {
            ...
            sameSizeList = this.groupedCards; // sameSizeList = GameLogic.getSameCardSizeList(value, GlobalData.cardInfo.sortCard, GlobalData.cardInfo.sortCard ? this.sorthandCardsValue : [], GlobalData.cardInfo.sortCard ? this.prevSelected : []);
        ...
        onBtnCardDir() {
          ...
          this.groupedCards = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            error: Error()
          }), GameLogic) : GameLogic).moveSelectedCardsToBack(this.handCardsValue, this.sorthandCardsValue, []); // ✅ 展平并重新渲染

          this.handCardsValue = this.groupedCards.flat();
          this.setHandCards(this.handCardsValue, true); // ✅ 清除选中
        ...
        showCardDir(show) {
          ...
          this.picOneCard.node.active = show; // if (show) {
...
//# sourceMappingURL=19ef0a6840c82c13211d505776707d196ab65534.js.map