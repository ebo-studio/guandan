      ...
      (function (_GameLogic) {
        ...
        function countThreeWithTwoAndStraight(unused) {
          ...
          for (var mainRank of sortedRanks) {
            ...
            if (mainIdxList.length < 3) continue; // 取三张

            var three = mainIdxList.slice(0, 3); // 再找对子（不能与主牌重复）
          ...
          switch (type) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop2 = function _loop2(_i30) {
...
//# sourceMappingURL=adbf4e43846f6457e83c115ee2b451f9749e4ac2.js.map