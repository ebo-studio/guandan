    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function countThreeWithTwoAndStraight(unused) {
          ...
          for (var _i11 = 0; _i11 < unused.length; _i11++) {
            var _rank5 = getCardSize(unused[_i11]);

            if (_rank5 >= 3 && _rank5 <= 14 && !usedIndex.has(_i11)) {
              if (!rankToIndexes.has(_rank5)) rankToIndexes.set(_rank5, []);
              rankToIndexes.get(_rank5).push(_i11);
            }
          }
          ...
          for (var _i12 = 0; _i12 < sorted.length; _i12++) {
            var r = sorted[_i12];
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i19 = groupedCards.length - 1; _i19 >= 0; _i19--) {
                var _group10 = groupedCards[_i19];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i20 = groupedCards.length - 1; _i20 >= 0; _i20--) {
                var _group11 = groupedCards[_i20];
              ...
              for (var _i21 = groupedCards.length - 1; _i21 >= 0; _i21--) {
                var _group12 = groupedCards[_i21];
              ...
              for (var _i22 = groupedCards.length - 1; _i22 >= 0; _i22--) {
                var _group13 = groupedCards[_i22];
              ...
              for (var _i23 = groupedCards.length - 1; _i23 >= 0; _i23--) {
                var _group14 = groupedCards[_i23];
              ...
              for (var _i24 = groupedCards.length - 1; _i24 >= 0; _i24--) {
                var _group15 = groupedCards[_i24];
              ...
              for (var _i25 = groupedCards.length - 1; _i25 >= 0; _i25--) {
                var _group16 = groupedCards[_i25];
              ...
              for (var _i26 = groupedCards.length - 1; _i26 >= 0; _i26--) {
                var _group17 = groupedCards[_i26];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i27 = groupedCards.length - 1; _i27 >= 0; _i27--) {
                  var _group18 = groupedCards[_i27];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i29 = groupedCards.length - 1; _i29 >= 0; _i29--) {
                var _group19 = groupedCards[_i29];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i31 = groupedCards.length - 1; _i31 >= 0; _i31--) {
                var _group21 = groupedCards[_i31];
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i36 = groupedCards.length - 1; _i36 >= 0; _i36--) {
                var _group26 = groupedCards[_i36];
            ...
            if (hintList.length === 0) {
              for (var _i37 = groupedCards.length - 1; _i37 >= 0; _i37--) {
                var _group27 = groupedCards[_i37];
            ...
            if (hintList.length === 0) {
              for (var _i38 = groupedCards.length - 1; _i38 >= 0; _i38--) {
                var _group28 = groupedCards[_i38];
            ...
            var _loop5 = function _loop5(_group31) {
...
//# sourceMappingURL=2adddd021faf8ace485074777b10565a35c2d0f3.js.map