    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getCardType(cards) {
          ...
          for (var _list of map.values()) {
            if (_list.length >= 4 && _list.length === cards.length) {
              switch (_list.length) {
                case 4:
                  return (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
                    error: Error()
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              if (hintList.length === 0) {
                for (var _i10 = groupedCards.length - 1; _i10 >= 0; _i10--) {
                  ...
                  if (_group6.length >= 4) {
                    var groupRank = getCompareSize(_group6[0]);
                    var targetRank = getCompareSize(targetCards[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i14 = groupedCards.length - 1; _i14 >= 0; _i14--) {
                ...
                if (_group9.length >= 4) {
                  var _groupRank = GameLogic.getCardSize(_group9[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop2 = function _loop2(_i15) {
                  var seq = allRanks.slice(_i15, _i15 + targetLength);
                  ...
                  if (isContinuous && seq[0] > targetStart) {
                    ...
                    for (var r of seq) {
                      _group10.push(rankMap.get(r).pop());
                    }
                ...
                for (var _i15 = 0; _i15 <= allRanks.length - targetLength; _i15++) {
                  var _ret = _loop2(_i15);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop3 = function _loop3(_i16) {
                  var seq = _allRanks.slice(_i16, _i16 + _targetLength);
                  ...
                  if (isContinuous && seq[0] > _targetStart) {
                    ...
                    for (var r of seq) {
                      _group11.push(_rankMap.get(r).pop());
                    }
                ...
                for (var _i16 = 0; _i16 <= _allRanks.length - _targetLength; _i16++) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i17 = 0; _i17 <= tripletGroups.length - _targetLength2 / 3; _i17++) {
                  var _group12 = [];
                  var ok = true;

                  for (var _j2 = 0; _j2 < _targetLength2 / 3; _j2++) {
                    var cur = tripletGroups[_i17 + _j2];

                    if (_j2 > 0 && cur.rank !== tripletGroups[_i17 + _j2 - 1].rank + 1) {
                      ok = false;
                      break;
                    }

                    _group12.push(...cur.cards);
                  }

                  if (ok && tripletGroups[_i17].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i18 = 0; _i18 <= pairGroups.length - _targetLength3 / 2; _i18++) {
                  var _group13 = [];
                  var _ok = true;

                  for (var _j3 = 0; _j3 < _targetLength3 / 2; _j3++) {
                    var _cur = pairGroups[_i18 + _j3];

                    if (_j3 > 0 && _cur.rank !== pairGroups[_i18 + _j3 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }

                    _group13.push(..._cur.cards);
                  }

                  if (_ok && pairGroups[_i18].rank > _targetMin) {
...
//# sourceMappingURL=2aecd514944fa1fe022f1c16254e3217264b2e1b.js.map