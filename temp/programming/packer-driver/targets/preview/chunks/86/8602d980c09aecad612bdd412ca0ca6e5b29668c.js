    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getOneCardSizeList(value) {
          ...
          var remainingPairs = pairs.filter(pair => !usedPairs.has(pair[0])); // ➕ 顺子 / 同花顺识别

          var remainCards = [...remainingPairs.flat(), ...otherGroups.flat()];
          ...
          var remainSingleList = remainAfterStraight.map(c => [c]); // 合并结果

          var tmpAll = [...tongHuaShunList, ...lianDuiList, ...shunziList, ...remainingPairs, ...otherGroups, ...remainSingleList];
        ...
        function getGroupPower(cards) {
          ...
          var allSame = cards.every(c => getCardSize(c) === getCardSize(cards[0])); // 四王炸
...
//# sourceMappingURL=8602d980c09aecad612bdd412ca0ca6e5b29668c.js.map