    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function countThreeWithTwoAndStraight(unused) {
          ...
          for (var _i9 = 0; _i9 < unused.length; _i9++) {
            var _rank5 = getCardSize(unused[_i9]);

            if (_rank5 >= 3 && _rank5 <= 14 && !usedIndex.has(_i9)) {
              if (!rankToIndexes.has(_rank5)) rankToIndexes.set(_rank5, []);
              rankToIndexes.get(_rank5).push(_i9);
            }
          }
          ...
          for (var _i10 = 0; _i10 < sorted.length; _i10++) {
            var r = sorted[_i10];
          ...
          switch (type) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i27 = groupedCards.length - 1; _i27 >= 0; _i27--) {
                var _group19 = groupedCards[_i27];
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i28 = 0; _i28 <= sizes.length - 5; _i28++) {
                  var ok = true;

                  for (var _j2 = 1; _j2 < 5; _j2++) {
                    if (sizes[_i28 + _j2] !== sizes[_i28 + _j2 - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop4 = function _loop4(_i30) {
                  var seq = allRanks.slice(_i30, _i30 + targetLength);
                ...
                for (var _i30 = 0; _i30 <= allRanks.length - targetLength; _i30++) {
                  var _ret3 = _loop4(_i30);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop5 = function _loop5(_i31) {
                  var seq = _allRanks.slice(_i31, _i31 + _targetLength);
                ...
                for (var _i31 = 0; _i31 <= _allRanks.length - _targetLength; _i31++) {
                  var _ret4 = _loop5(_i31);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i32 = 0; _i32 <= tripletGroups.length - _targetLength2 / 3; _i32++) {
                  var _group24 = [];
                  var _ok = true;

                  for (var _j4 = 0; _j4 < _targetLength2 / 3; _j4++) {
                    var cur = tripletGroups[_i32 + _j4];

                    if (_j4 > 0 && cur.rank !== tripletGroups[_i32 + _j4 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }
                  ...
                  if (_ok && tripletGroups[_i32].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i33 = 0; _i33 <= pairGroups.length - _targetLength3 / 2; _i33++) {
                  var _group25 = [];
                  var _ok2 = true;

                  for (var _j5 = 0; _j5 < _targetLength3 / 2; _j5++) {
                    var _cur = pairGroups[_i33 + _j5];

                    if (_j5 > 0 && _cur.rank !== pairGroups[_i33 + _j5 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }
                  ...
                  if (_ok2 && pairGroups[_i33].rank > _targetMin) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i35 = groupedCards.length - 1; _i35 >= 0; _i35--) {
                var _group27 = groupedCards[_i35];
            ...
            if (hintList.length === 0) {
              for (var _i36 = groupedCards.length - 1; _i36 >= 0; _i36--) {
                var _group28 = groupedCards[_i36];
...
//# sourceMappingURL=86a8490f28b7dd3cf6c24fcb17d781d7a210e5f1.js.map