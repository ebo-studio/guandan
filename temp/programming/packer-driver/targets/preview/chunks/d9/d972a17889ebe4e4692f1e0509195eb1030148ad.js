        ...
        function findBombsByCount(cards, count) {
          ...
          for (var card of cards) {
            ...
            if (rank === (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              frpCards.push(card); // 红桃级牌（可用作逢人配）
            } else {
          ...
          for (var [_rank, group] of map.entries()) {
            ...
            if (group.length === count - 1) {
              for (var frp of frpCards) {
                if (!usedFrp.has(frp)) {
                  result.push([...group, frp]);
                  usedFrp.add(frp); // 一次使用机会
...
//# sourceMappingURL=d972a17889ebe4e4692f1e0509195eb1030148ad.js.map