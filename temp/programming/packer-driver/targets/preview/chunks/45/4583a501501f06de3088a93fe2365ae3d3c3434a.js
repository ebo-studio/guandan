      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        onBtnHint() {
          ...
          if (this.outCardList.length == 1 && ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            if (!found) {
              var bombs = grouped.filter(g => g.length == 2);

              if (bombs.length > 0) {
                var bomb = bombs[this.breakPairIndex % bombs.length];
                this.selectCardValue = [bomb[0]];
                this.breakBombIndex++;
                found = true;
              } // const hintCard = this.hintCards[this.hintIndex][0];
            ...
            if (!found) {
              var _bombs = grouped.filter(g => g.length >= 4);

              if (_bombs.length > 0) {
                var _bomb = _bombs[this.breakBombIndex % _bombs.length];
                this.selectCardValue = [_bomb[0]];
                this.breakBombIndex++;
                found = true;
              }
...
//# sourceMappingURL=4583a501501f06de3088a93fe2365ae3d3c3434a.js.map