        ...
        setData(obj) {
          ...
          if (data.type == (_crd && GameEndType === void 0 ? (_reportPossibleCrUseOfGameEndType({
            ...
            for (var i = 0; i < list.list.length; i++) {
              ...
              this.headItems[i].setData(_data);
            }
            ...
            for (var _i = 0; _i < this.tmpData.list.length; _i++) {
              var _item = this.tmpData.list[_i];
              var viewId = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getUserViewIdById(_item.id);
              var _data2 = {
                rank: _item.res,
                head: _item.headImg,
                name: _item.name,
...
//# sourceMappingURL=4590ff11b9ec9002ac10901061dfe1a8f213e45a.js.map