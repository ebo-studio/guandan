System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, AVirtualScrollView, GlobalData, RankScorePersonSelfLine, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, RankScorePerson;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "00ac3Llc7VLXINH/gZsWtUv", "RankScorePerson", undefined);
      ...
      _export("RankScorePerson", RankScorePerson = (_dec = ccclass('RankScorePerson'), _dec2 = property(_crd && AVirtualScrollView === void 0 ? (_reportPossibleCrUseOfAVirtualScrollView({
        error: Error()
        ...
        error: Error()
      }), RankScorePersonSelfLine) : RankScorePersonSelfLine), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = class RankScorePerson extends Component {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=dbb9210a9f08e5093ce54ccddb3e0dcfb63fa949.js.map