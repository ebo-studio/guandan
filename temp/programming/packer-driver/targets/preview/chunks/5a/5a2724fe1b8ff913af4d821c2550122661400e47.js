      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        onBtnHint() {
          ...
          if (this.outCardList.length == 1 && ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            var found = false; // 排序后的 hint 列表，不影响原始数据

            var sortedHints = [...this.hintCards].sort((a, b) => a.length - b.length);
            ...
            var totalHints = sortedHints.length;

            for (var i = 0; i < totalHints; i++) {
              var index = (this.hintIndex + i) % totalHints;
              var hint = sortedHints[index];
            ...
            var hintRaw = this.hintCards[this.hintIndex]; // 原始 hint（不排序）

            if (!found && (hintRaw == null ? void 0 : hintRaw.length) === 1) {
              var hintCard = hintRaw[0];
...
//# sourceMappingURL=5a2724fe1b8ff913af4d821c2550122661400e47.js.map