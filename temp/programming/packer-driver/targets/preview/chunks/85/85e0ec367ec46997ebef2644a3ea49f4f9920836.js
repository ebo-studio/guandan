    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected) {
          ...
          var prevSet = new Set(prevSelected); // 找出 selected 中不在 prevSelected 里的部分，即“新增的牌”
          ...
          if (temp.length > 0) groupList.push(temp); // 新增选中的牌，从 cards 中提取一次，保持顺序
          ...
          if (thisGroup.length > 0) {
            groupList.push(thisGroup); // 👈 每次新增都只加一组
          }
...
//# sourceMappingURL=85e0ec367ec46997ebef2644a3ea49f4f9920836.js.map