        ...
        setHandCards(value, ani, isUp, isOneCard) {
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            for (var _i = 0; _i < value.length; _i++) {
              ...
              var cardSps = this.getCardsSprite(_value);

              if (cardSps) {
                card.setValue(_value, cardSps);
              }
            ...
            // let sameSizeList;
            // if (isOneCard) {
            //     sameSizeList = GameLogic.getOneCardSizeList(value);
            // }
            // else {
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            for (var _i4 = this.handCards.length - 1; _i4 >= 0; _i4--) {
              ...
              if (_item != null) {
                ...
                var tmpPosY = this.handCards[_i4].getBottom() ? _posyYB : _posY2 - this.cardDistance_V; //下边界点
...
//# sourceMappingURL=85c4777b020d6ea19f9234abbf5e4a4793c5d3fb.js.map