      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        updateSelectedCards_V() {
          ...
          function isSameGroupStrict(g1, g2) {
            ...
            var sorted1 = [...g1].sort((a, b) => a - b);
            var sorted2 = [...g2].sort((a, b) => a - b);
            return sorted1.every((c, i) => c === sorted2[i]);
          } // let isRecover = false;


          var selectedSorted = [...this.selectCardValue].sort((a, b) => a - b);
          var len = this.selectCardValue.length; // 遍历理牌后的整副牌中所有等长片段，判断是否完全匹配

          for (var i = 0; i <= this.sorthandCardsValue.length - len; i++) {
            var slice = this.sorthandCardsValue.slice(i, i + len);
...
//# sourceMappingURL=5836e48e0ae23d1dcecbe96cd92d301abbcc79b3.js.map