        ...
        function findThreeWithTwo(cards) {
          ...
          for (var [rank, list] of map.entries()) {
            if (rank === (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).cardInfo.levelCard) continue; // ❌ 不用级牌（2）
          ...
          for (var three of threes) {
            var rank3 = getCardSize(three[0]);

            for (var pair of pairs) {
              var rank2 = getCardSize(pair[0]);
...
//# sourceMappingURL=b4e8c3fc27699bc45559436cae3c4f6402ff228d.js.map