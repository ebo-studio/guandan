    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected) {
          ...
          var selectedSet = new Set(selectedHistory); // 2. 查找三带二组合（从历史选中中识别）
          ...
          for (var j = 0; j < uniqueList.length; j++) {
            ...
            for (var i = idx; i < sortValue.length; i++) {
              ...
              if (usedSet.has(card)) continue; // ✅ 已在组合组中，跳过

              if (getCardSize(d) === getCardSize(card)) {
                list1.push(card);
...
//# sourceMappingURL=d2737e06765b958aba97a145e01e1d874fb0b389.js.map