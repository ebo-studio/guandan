  ...
  return {
    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getRemainCardsByDelete(value, deleteCards, keepOrder, select) {
          if (keepOrder === void 0) {
            keepOrder = false;
          }
          ...
          var tmpList = [];
          var sameSizeList = GameLogic.getSameCardSizeList(value, keepOrder, select);
        ...
        function getSameCardSizeList(value, keepOrder, select) {
          if (keepOrder === void 0) {
            keepOrder = false;
          }
          ...
          if (!keepOrder) {
            ...
            return moveSelectedCardsToBack(value, select);
          }
        }
        ...
        function moveSelectedCardsToBack(cards, selected) {
          ...
          if (temp.length > 0) groupList.push(temp); // 新建一组：这次理牌选中的牌（按 cards 原始顺序）

          var selectedGroup = [];

          for (var card of cards) {
            if (selected.includes(card)) {
              selectedGroup.push(card);
            }
          }

          if (selectedGroup.length > 0) {
            groupList.push(selectedGroup); // 👈 每次理牌都是新增一个组
          }
...
//# sourceMappingURL=1f3d43cd000cea8f9e9657be065d226fc81c77e2.js.map