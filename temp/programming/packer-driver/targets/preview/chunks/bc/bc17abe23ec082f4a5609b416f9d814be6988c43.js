    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function manualSortCards(selected, prevSelected, prevGrouped, allCards) {
          ...
          for (var [_rank, list] of countMap.entries()) {
            if (list.length >= 6) {
              result.unshift(list);
          ...
          for (var [_rank2, _list] of rankMap.entries()) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          for (var _group7 of lianduiGroups) {
        ...
        function getCardTypeByFeiji(cards) {
          ...
          for (var _rank4 of sortedRanks) {
            var list = countMap.get(_rank4);

            if (list.length === 3) {
              tripletRanks.push(_rank4);
        ...
        function getTripleWithPairPreferBig(cards) {
          ...
          for (var _rank5 of ranksSorted) {
            var list = rankMap.get(_rank5);
        ...
        function findBombsByCount(cards, count) {
          ...
          for (var [_rank7, group] of map.entries()) {
        ...
        function findFlushStraight(cards) {
          ...
          for (var [_color, colorCards] of colorMap.entries()) {
            ...
            for (var _card2 of colorCards) {
              var _rank8 = _card2 % 16;

              if (!rankMap.has(_rank8)) rankMap.set(_rank8, []);
              rankMap.get(_rank8).push(_card2);
            }
        ...
        function findStraight_I(cards) {
          ...
          while (i <= ranks.length - 5) {
            ...
            if (length == 5) {
              ...
              for (var _rank9 of seq) {
                var cardsOfRank = map.get(_rank9);
          ...
          while (i <= sortedRanks.length - 5) {
            ...
            if (isConsecutive) {
              ...
              for (var _rank10 of seq) {
                var available = rankMap.get(_rank10).filter(idx => !usedIndex.has(idx));
        ...
        function countThreeWithTwoAndStraight(unused) {
          ...
          for (var _i13 = 0; _i13 < unused.length; _i13++) {
            var _rank11 = getCardSize(unused[_i13]);

            if (_rank11 >= 3 && _rank11 <= 14 && !usedIndex.has(_i13)) {
              if (!rankToIndexes.has(_rank11)) rankToIndexes.set(_rank11, []);
              rankToIndexes.get(_rank11).push(_i13);
            }
          }
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i15 = groupedCards.length - 1; _i15 >= 0; _i15--) {
                var _group8 = groupedCards[_i15];

                if (_group8.length === 2) {
                  var _card3 = _group8[0];
              ...
              for (var _i17 = groupedCards.length - 1; _i17 >= 0; _i17--) {
                ...
                if (_group10.length == 4) {
                  var bombs = GameLogic.newfindBombs(_group10);
              ...
              for (var _i18 = groupedCards.length - 1; _i18 >= 0; _i18--) {
                ...
                if (_group11.length == 5) {
                  var _bombs = GameLogic.newfindBombs(_group11);
              ...
              for (var _i19 = groupedCards.length - 1; _i19 >= 0; _i19--) {
                var _group12 = groupedCards[_i19];

                if (_group12.length == 5) {
                  var _bombs2 = GameLogic.findFlushStraight(_group12);
              ...
              for (var _i20 = groupedCards.length - 1; _i20 >= 0; _i20--) {
                var _group13 = groupedCards[_i20];

                if (_group13.length == 6) {
                  var _bombs3 = GameLogic.newfindBombs(_group13);
              ...
              for (var _i21 = groupedCards.length - 1; _i21 >= 0; _i21--) {
                var _group14 = groupedCards[_i21];

                if (_group14.length == 4) {
                  var _bombs4 = GameLogic.findRocket(_group14);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i24 = groupedCards.length - 1; _i24 >= 0; _i24--) {
                ...
                if (_group17.length == 4) {
                  var _bombs5 = GameLogic.newfindBombs(_group17);
              ...
              for (var _i25 = groupedCards.length - 1; _i25 >= 0; _i25--) {
                ...
                if (_group18.length == 5) {
                  var _bombs6 = GameLogic.newfindBombs(_group18);
              ...
              for (var _i26 = groupedCards.length - 1; _i26 >= 0; _i26--) {
                var _group19 = groupedCards[_i26];

                if (_group19.length == 5) {
                  var _bombs7 = GameLogic.findFlushStraight(_group19);
              ...
              for (var _i27 = groupedCards.length - 1; _i27 >= 0; _i27--) {
                var _group20 = groupedCards[_i27];

                if (_group20.length == 6) {
                  var _bombs8 = GameLogic.newfindBombs(_group20);
              ...
              for (var _i28 = groupedCards.length - 1; _i28 >= 0; _i28--) {
                var _group21 = groupedCards[_i28];

                if (_group21.length == 4) {
                  var _bombs9 = GameLogic.findRocket(_group21);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i31 = groupedCards.length - 1; _i31 >= 0; _i31--) {
                var _group23 = groupedCards[_i31];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i33 = groupedCards.length - 1; _i33 >= 0; _i33--) {
                var _group25 = groupedCards[_i33];
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i38 = groupedCards.length - 1; _i38 >= 0; _i38--) {
                var _group30 = groupedCards[_i38];
        ...
        function newfindBombs(cards, levelRank) {
          ...
          for (var _rank13 of sortedRanks) {
            var group = countMap.get(_rank13);
...
//# sourceMappingURL=bc17abe23ec082f4a5609b416f9d814be6988c43.js.map