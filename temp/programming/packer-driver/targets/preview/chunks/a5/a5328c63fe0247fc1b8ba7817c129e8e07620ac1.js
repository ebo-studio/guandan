    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          for (var s of straights) {
            ...
            for (var _i12 = 0; _i12 < cards.length; _i12++) {
              if (s.includes(cards[_i12])) usedIndex.add(_i12);
          ...
          for (var _group8 of lianduiGroups) {
            ...
            for (var _i13 = 0; _i13 < cards.length; _i13++) {
              if (_group8.includes(cards[_i13])) usedIndex.add(_i13);
            } // group.forEach(c => usedCards.add(c));
          ...
          for (var [rank, list] of countMap.entries()) {
            if (list.length === 2) {
              ...
              for (var _i15 = 0; _i15 < cards.length; _i15++) {
                if (list.includes(cards[_i15])) usedIndex.add(_i15);
              }
            }
          } // // ✅ 步骤8：将剩余未处理的牌按点数分组
          ...
          var remaining = cards.filter((_, idx) => !usedIndex.has(idx));
          var sortValue = sortCardsBySizeDown(remaining, remaining.length); // 分组逻辑替换掉 uniqueList + idx 遍历方式

          var rankMap = new Map();

          for (var _i16 = 0; _i16 < cards.length; _i16++) {
            if (usedIndex.has(_i16)) continue;

            var _rank5 = getCardSize(cards[_i16]);

            if (!rankMap.has(_rank5)) rankMap.set(_rank5, []);
            rankMap.get(_rank5).push(_i16);
          }

          for (var indexes of rankMap.values()) {
            var _group9 = indexes.map(i => cards[i]);
        ...
        function getOneCardSizeList(value) {
          ...
          for (var _i17 = 0; _i17 < pairs.length; _i17++) {
            if (temp.length === 0) {
              temp.push(pairs[_i17]);
            } else {
              var last = getCardSize(temp[temp.length - 1][0]);
              var current = getCardSize(pairs[_i17][0]);
          ...
          var findStraightGroups = cards => {
            ...
            for (var _i18 = 0; _i18 < unique.length; _i18++) {
              var cur = unique[_i18];
        ...
        function getGroupPower(cards) {
          ...
          if (size >= 4 && size % 2 === 0) {
            ...
            for (var _i19 = 1; _i19 < pairs.length; _i19++) {
              if (pairs[_i19] !== pairs[_i19 - 1] + 1 || pairs[_i19] >= 15) return 0;
            }
        ...
        function findStraight_II(cards, usedIndex) {
          ...
          for (var _i20 = 0; _i20 < cards.length; _i20++) {
            if (usedIndex.has(_i20)) continue;
            var card = cards[_i20];
            var rank = card % 16;
            if (rank < 3 || rank > 13) continue; // 只允许 3~K 进入顺子

            if (!rankMap.has(rank)) rankMap.set(rank, []);
            rankMap.get(rank).push(_i20); // 保存的是索引，方便精确控制使用
          }
        ...
        function countThreeWithTwoAndStraight(unused) {
          ...
          for (var _i21 = 0; _i21 < unused.length; _i21++) {
            var _rank12 = getCardSize(unused[_i21]);

            if (_rank12 >= 3 && _rank12 <= 14 && !usedIndex.has(_i21)) {
              if (!rankToIndexes.has(_rank12)) rankToIndexes.set(_rank12, []);
              rankToIndexes.get(_rank12).push(_i21);
            }
          }
          ...
          for (var _i22 = 0; _i22 < sorted.length; _i22++) {
            var r = sorted[_i22];
        ...
        function getHintCards(targetCards, groupedCards) {
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i26 = result_three.length - 1; _i26 >= 0; _i26--) {
                var _group13 = result_three[_i26]; // if (group.length == 4) {
              ...
              for (var _i27 = result.length - 1; _i27 >= 0; _i27--) {
                var _group14 = result[_i27]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i28 = sameShunzi.length - 1; _i28 >= 0; _i28--) {
                var _group15 = sameShunzi[_i28];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i32 = groupedCards.length - 1; _i32 >= 0; _i32--) {
                var _group19 = groupedCards[_i32];
              ...
              for (var _i33 = result_three1.length - 1; _i33 >= 0; _i33--) {
                var _group20 = result_three1[_i33]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i34 = result1.length - 1; _i34 >= 0; _i34--) {
                var _group21 = result1[_i34]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i35 = sameShunzi1.length - 1; _i35 >= 0; _i35--) {
                var _group22 = sameShunzi1[_i35];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i37 = groupedCards.length - 1; _i37 >= 0; _i37--) {
                  var _group24 = groupedCards[_i37];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i40 = 0; _i40 <= sizes.length - 5; _i40++) {
                  var ok = true;

                  for (var _j2 = 1; _j2 < 5; _j2++) {
                    if (sizes[_i40 + _j2] !== sizes[_i40 + _j2 - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i41 = groupedCards.length - 1; _i41 >= 0; _i41--) {
                var _group27 = groupedCards[_i41];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop5 = function _loop5(_i42) {
                  var seq = allRanks.slice(_i42, _i42 + targetLength);
                ...
                for (var _i42 = 0; _i42 <= allRanks.length - targetLength; _i42++) {
                  var _ret5 = _loop5(_i42);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop6 = function _loop6(_i43) {
                  var seq = _allRanks.slice(_i43, _i43 + _targetLength);
                ...
                for (var _i43 = 0; _i43 <= _allRanks.length - _targetLength; _i43++) {
                  var _ret6 = _loop6(_i43);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i44 = 0; _i44 <= tripletGroups.length - _targetLength2 / 3; _i44++) {
                  var _group30 = [];
                  var _ok = true;

                  for (var _j4 = 0; _j4 < _targetLength2 / 3; _j4++) {
                    var cur = tripletGroups[_i44 + _j4];

                    if (_j4 > 0 && cur.rank !== tripletGroups[_i44 + _j4 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }
                  ...
                  if (_ok && tripletGroups[_i44].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i45 = 0; _i45 <= pairGroups.length - _targetLength3 / 2; _i45++) {
                  var _group31 = [];
                  var _ok2 = true;

                  for (var _j5 = 0; _j5 < _targetLength3 / 2; _j5++) {
                    var _cur = pairGroups[_i45 + _j5];

                    if (_j5 > 0 && _cur.rank !== pairGroups[_i45 + _j5 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }
                  ...
                  if (_ok2 && pairGroups[_i45].rank > _targetMin) {
        ...
        function getHintList(handCards, targetCards) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i48 = groupedCards.length - 1; _i48 >= 0; _i48--) {
                var _group34 = groupedCards[_i48];
...
//# sourceMappingURL=a5328c63fe0247fc1b8ba7817c129e8e07620ac1.js.map