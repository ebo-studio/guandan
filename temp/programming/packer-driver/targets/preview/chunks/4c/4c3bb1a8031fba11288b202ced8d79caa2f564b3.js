    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          var sortValue = sortCardsBySizeDown(remaining, remaining.length); // ✅ 按点数分组（保留所有重复牌）

          var rankMap = new Map();

          for (var card of sortValue) {
            var _rank5 = getCardSize(card);
...
//# sourceMappingURL=4c3bb1a8031fba11288b202ced8d79caa2f564b3.js.map