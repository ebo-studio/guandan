      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          for (var indexes of rankMap.values()) {
            var _group9 = indexes.map(i => cards[i]); // 当前组


            var hasSelected = indexes.some(i => selectedIndexSet.has(i)); // 判断是否被选中
            // 将选中的组移到末尾，未选中的保留在前面

            (hasSelected ? moveToBack : result).push(_group9); // 标记这些牌已使用
...
//# sourceMappingURL=06e79ae874015792d842b35c3990bce0c53b5842.js.map