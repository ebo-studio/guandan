    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getRemainCardsByDelete(value, deleteCards, keepOrder, select, prevSelected) {
          ...
          var usedSet = new Set(); // 标记已经删除的牌（精确牌值）

          var _loop = function _loop(i) {
            var card = flatList[i];
            var indexInDelete = deleteCards.findIndex(c => c === card && !usedSet.has(c));
        ...
        function getOneCardSizeList(value) {
          ...
          for (var _i4 = 0; _i4 < pairs.length; _i4++) {
            if (temp.length === 0) {
              ...
              var current = getCardSize(pairs[_i4][0]);
          ...
          var findStraightGroups = cards => {
            ...
            for (var _i5 = 0; _i5 < unique.length; _i5++) {
              var cur = unique[_i5];
        ...
        function getGroupPower(cards) {
          ...
          if (size >= 4 && size % 2 === 0) {
            ...
            for (var _i6 = 1; _i6 < pairs.length; _i6++) {
              if (pairs[_i6] !== pairs[_i6 - 1] + 1 || pairs[_i6] >= 15) return 0;
            }
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              if (hintList.length === 0) {
                for (var _i7 = groupedCards.length - 1; _i7 >= 0; _i7--) {
                  var _group4 = groupedCards[_i7];
              ...
              if (hintList.length === 0) {
                for (var _i9 = groupedCards.length - 1; _i9 >= 0; _i9--) {
                  var _group6 = groupedCards[_i9]; // 只判断是否为炸弹（四张及以上，同点数）
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i14 = 0; _i14 <= sizes.length - 5; _i14++) {
                  var ok = true;

                  for (var _j = 1; _j < 5; _j++) {
                    if (sizes[_i14 + _j] !== sizes[_i14 + _j - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop3 = function _loop3(_i16) {
                  var seq = allRanks.slice(_i16, _i16 + targetLength);
                ...
                for (var _i16 = 0; _i16 <= allRanks.length - targetLength; _i16++) {
                  var _ret2 = _loop3(_i16);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop4 = function _loop4(_i17) {
                  var seq = _allRanks.slice(_i17, _i17 + _targetLength);
                ...
                for (var _i17 = 0; _i17 <= _allRanks.length - _targetLength; _i17++) {
                  var _ret3 = _loop4(_i17);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i18 = 0; _i18 <= tripletGroups.length - _targetLength2 / 3; _i18++) {
                  var _group14 = [];
                  var _ok = true;

                  for (var _j3 = 0; _j3 < _targetLength2 / 3; _j3++) {
                    var cur = tripletGroups[_i18 + _j3];

                    if (_j3 > 0 && cur.rank !== tripletGroups[_i18 + _j3 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }
                  ...
                  if (_ok && tripletGroups[_i18].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i19 = 0; _i19 <= pairGroups.length - _targetLength3 / 2; _i19++) {
                  var _group15 = [];
                  var _ok2 = true;

                  for (var _j4 = 0; _j4 < _targetLength3 / 2; _j4++) {
                    var _cur = pairGroups[_i19 + _j4];

                    if (_j4 > 0 && _cur.rank !== pairGroups[_i19 + _j4 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }
                  ...
                  if (_ok2 && pairGroups[_i19].rank > _targetMin) {
        ...
        function getHintList(handCards, targetCards) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            var _loop5 = function _loop5(_group21) {
...
//# sourceMappingURL=becf5a3df1b1692881a512f9feb2414e85afac62.js.map