      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        updateSelectedCards_V() {
          ...
          function isSameIndexGroup(a, b) {
            ...
            var sa = [...a].sort((x, y) => x - y);
            var sb = [...b].sort((x, y) => x - y);
            return sa.every((v, i) => v === sb[i]);
          } // let isRecover = false;


          var selectedIndexes = getSelectedIndexes(this.handCardsValue, this.selectCardValue);
          var groupedIndexes = getGroupedIndexes(this.handCardsValue, this.groupedCards);
          var isRecover = groupedIndexes.some(groupIdxs => isSameIndexGroup(groupIdxs, selectedIndexes));
...
//# sourceMappingURL=dfa9e3b7e304cef2d9353fe5669934671ef871d8.js.map