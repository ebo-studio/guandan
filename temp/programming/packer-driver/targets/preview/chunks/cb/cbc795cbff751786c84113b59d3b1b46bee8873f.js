    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function groupByRankAsc(cards) {
          var sorted = sortCardsBySizeUp(cards, cards.length); // ⬅️ 升序排序
        ...
        function findLiandui(cards) {
          ...
          for (var card of normalCards) {
            var rank = getCardRank(card);
            if (rank < 3 || rank > 13) continue; // 排除2和王
        ...
        function findFeiji(cards) {
          ...
          for (var card of normalCards) {
            var rank = getCardRank(card);
            if (rank < 3 || rank > 13) continue; // 排除 2 和王
        ...
        function getCardTypeByLiandui(cards) {
          ...
          var isHeartCard = card => getCardRank(card) === 2 && getCardColor(card) === 1;
        ...
        function getCardType(cards) {
          ...
          if (cards.length === 5) {
            var map = getTripleWithPairPreferBig(cards);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i24 = groupedCards.length - 1; _i24 >= 0; _i24--) {
                ...
                if (_group18.length == 4) {
                  var _bombs5 = GameLogic.newfindBombs(_group18);
              ...
              for (var _i25 = groupedCards.length - 1; _i25 >= 0; _i25--) {
                ...
                if (_group19.length == 5) {
                  var _bombs6 = GameLogic.newfindBombs(_group19);
              ...
              for (var _i26 = groupedCards.length - 1; _i26 >= 0; _i26--) {
                ...
                if (_group20.length == 5) {
                  var _bombs7 = GameLogic.findFlushStraight(_group20);
              ...
              for (var _i27 = groupedCards.length - 1; _i27 >= 0; _i27--) {
                ...
                if (_group21.length == 6) {
                  var _bombs8 = GameLogic.newfindBombs(_group21);
              ...
              for (var _i28 = groupedCards.length - 1; _i28 >= 0; _i28--) {
                ...
                if (_group22.length == 4) {
                  var _bombs9 = GameLogic.findRocket(_group22);
...
//# sourceMappingURL=cbc795cbff751786c84113b59d3b1b46bee8873f.js.map