        ...
        loadAllPrefabs() {
          ...
          return _asyncToGenerator(function* () {
            ...
            resources.loadDir('prefab', (completedCount, totalCount, item) => {
              console.log(completedCount, totalCount); // let progress = parseFloat(((completedCount) / (totalCount)).toFixed(3));

              _this.updateProgress(completedCount / totalCount);
            }, (error, assets) => {});
          })();
        }
...
//# sourceMappingURL=41abd13b13c60d9a105544170fc9a354fa053d32.js.map