    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function findFeiji(cards) {
          ...
          var redCards = cards.filter(isHeartCard);
          var normalCards = cards.filter(c => !isHeartCard(c)); // 统计普通牌：rank -> cards
          ...
          for (var card of normalCards) {
            ...
            if (_rank5 < 3 || _rank5 > 14) continue; // 排除 2 和王
          ...
          for (var _i7 = 0; _i7 < tripletRanks.length - 1; _i7++) {
            var curr = tripletRanks[_i7];
            var next = tripletRanks[_i7 + 1];

            if (next === curr + 1) {
              return [[...rankToTriplet[curr], ...rankToTriplet[next]]];
            }
          }
...
//# sourceMappingURL=32d7f457342e681f0e5eab1b47fff281e7da7551.js.map