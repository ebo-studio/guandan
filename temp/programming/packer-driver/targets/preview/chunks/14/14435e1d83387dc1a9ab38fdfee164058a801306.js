          ...
          for (var i = 0; i < sortValue.length; i++) {
            ...
            if (currentGroup.length === 0 || getCardSize(card) === getCardSize(currentGroup[0])) {
              ...
              if (currentGroup.length > 0) {
                if (currentGroup.some(c => selectedSet.has(c))) {
                  moveToBack.push(currentGroup);
                } else {
                  result.push(currentGroup);
                }

                currentGroup.forEach(c => usedCards.add(c));
              }
        ...
        function findFlushStraight(cards) {
          ...
          for (var [_color2, colorCards] of colorMap.entries()) {
            ...
            for (var _card3 of colorCards) {
              var _rank8 = _card3 % 16;

              if (!rankMap.has(_rank8)) rankMap.set(_rank8, []);
              rankMap.get(_rank8).push(_card3);
            }
...
//# sourceMappingURL=14435e1d83387dc1a9ab38fdfee164058a801306.js.map