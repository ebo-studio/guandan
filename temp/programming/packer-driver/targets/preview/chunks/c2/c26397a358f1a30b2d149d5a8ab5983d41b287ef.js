  ...
  return {
    ...
    execute: function () {
      ...
      (function (_UIConfig) {
        ...
        var MessageBoxCommonKey = _UIConfig.MessageBoxCommonKey = "MessageBoxCommon";
        var MessageBoxCommonTestKey = _UIConfig.MessageBoxCommonTestKey = "MessageBoxCommonTest";
        var SettingItemKey = _UIConfig.SettingItemKey = "SettingItem";
        var MessageHintKey = _UIConfig.MessageHintKey = "MessageHint";
        var LoadItemKey = _UIConfig.LoadItemKey = "LoadItem";
        var WaitItemKey = _UIConfig.WaitItemKey = "WaitItem";
        var RankItemKey = _UIConfig.RankItemKey = "RankItem";
        var RuleItemKey = _UIConfig.RuleItemKey = "RuleItem";
        var KeyBoardItemKey = _UIConfig.KeyBoardItemKey = "KeyBoardItem";
        var TeamItemKey = _UIConfig.TeamItemKey = "TeamItem";
        var CreateRoomItemKey = _UIConfig.CreateRoomItemKey = "CreateRoomItem";
        var GameEndFreeItemKey = _UIConfig.GameEndFreeItemKey = "GameEndFreeItem";
        var GameEndAuditionItemKey = _UIConfig.GameEndAuditionItemKey = "GameEndAuditionItem";
        var GameEndScoreItemKey = _UIConfig.GameEndScoreItemKey = "GameEndScoreItem";
        var GameEndKickItemKey = _UIConfig.GameEndKickItemKey = "GameEndKickItem";
        var GameEndScoreRankItemKey = _UIConfig.GameEndScoreRankItemKey = "GameEndScoreRankItem";
        var GameEndKickUpItemKey = _UIConfig.GameEndKickUpItemKey = "GameEndKickUpItem";
        var TeamUpItemKey = _UIConfig.TeamUpItemKey = "TeamUpItem";
        var RaceScoreItemKey = _UIConfig.RaceScoreItemKey = "RaceScoreItem";
        var RaceKickItemKey = _UIConfig.RaceKickItemKey = "RaceKickItem";
        var RaceAuditionItemKey = _UIConfig.RaceAuditionItemKey = "RaceAuditionItem";
        var CreateTeamItemKey = _UIConfig.CreateTeamItemKey = "CreateTeamItem";
        var GameStartNoticeKey = _UIConfig.GameStartNoticeKey = "GameStartNotice";
        var FreeUpItemKey = _UIConfig.FreeUpItemKey = "FreeUpItem";
        var RankRaceItemKey = _UIConfig.RankRaceItemKey = "RankRaceItem";
        var RankScoreItemKey = _UIConfig.RankScoreItemKey = "RankScoreItem";
        var RankKickItemKey = _UIConfig.RankKickItemKey = "RankKickItem";
        var RankAuditionItemKey = _UIConfig.RankAuditionItemKey = "RankAuditionItem";
        var FreeMatchItemKey = _UIConfig.FreeMatchItemKey = "FreeMatchItem";
        var AuditionMatchItemKey = _UIConfig.AuditionMatchItemKey = "AuditionMatchItem";
...
//# sourceMappingURL=c26397a358f1a30b2d149d5a8ab5983d41b287ef.js.map