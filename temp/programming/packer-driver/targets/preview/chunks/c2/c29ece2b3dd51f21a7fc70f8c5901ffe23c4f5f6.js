    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getHintCards(targetCards, groupedCards) {
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i18 = result.length - 1; _i18 >= 0; _i18--) {
                var _group12 = result[_i18]; // if (group.length == 4) {
              ...
              for (var _i19 = groupedCards.length - 1; _i19 >= 0; _i19--) {
                ...
                if (_group13.length == 5) {
                  var _bombs = GameLogic.findFlushStraight(_group13);
              ...
              for (var _i20 = groupedCards.length - 1; _i20 >= 0; _i20--) {
                ...
                if (_group14.length == 4) {
                  var _bombs2 = GameLogic.findRocket(_group14);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i21 = groupedCards.length - 1; _i21 >= 0; _i21--) {
                ...
                if (_group15.length === 2) {
                  var _card5 = _group15[0];
              ...
              for (var _i22 = groupedCards.length - 1; _i22 >= 0; _i22--) {
                var _group16 = groupedCards[_i22];

                if (_group16.length === 3) {
                  var _card6 = _group16[0];
              ...
              for (var _i23 = groupedCards.length - 1; _i23 >= 0; _i23--) {
                var _group17 = groupedCards[_i23];

                if (_group17.length == 4) {
                  var _bombs3 = GameLogic.newfindBombs(_group17);
              ...
              for (var _i24 = groupedCards.length - 1; _i24 >= 0; _i24--) {
                ...
                if (_group18.length == 5) {
                  var _bombs4 = GameLogic.newfindBombs(_group18);
              ...
              for (var _i25 = groupedCards.length - 1; _i25 >= 0; _i25--) {
                ...
                if (_group19.length == 5) {
                  var _bombs5 = GameLogic.findFlushStraight(_group19);
              ...
              for (var _i27 = groupedCards.length - 1; _i27 >= 0; _i27--) {
                ...
                if (_group21.length == 4) {
                  var _bombs7 = GameLogic.findRocket(_group21);
              ...
              for (var _i28 = result1.length - 1; _i28 >= 0; _i28--) {
                var _group22 = result1[_i28]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i31 = groupedCards.length - 1; _i31 >= 0; _i31--) {
                var _group24 = groupedCards[_i31];
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i32 = 0; _i32 <= sizes.length - 5; _i32++) {
                  var ok = true;

                  for (var _j2 = 1; _j2 < 5; _j2++) {
                    if (sizes[_i32 + _j2] !== sizes[_i32 + _j2 - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop4 = function _loop4(_i34) {
                  var seq = allRanks.slice(_i34, _i34 + targetLength);
                ...
                for (var _i34 = 0; _i34 <= allRanks.length - targetLength; _i34++) {
                  var _ret4 = _loop4(_i34);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop5 = function _loop5(_i35) {
                  var seq = _allRanks.slice(_i35, _i35 + _targetLength);
                ...
                for (var _i35 = 0; _i35 <= _allRanks.length - _targetLength; _i35++) {
                  var _ret5 = _loop5(_i35);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i36 = 0; _i36 <= tripletGroups.length - _targetLength2 / 3; _i36++) {
                  var _group29 = [];
                  var _ok = true;

                  for (var _j4 = 0; _j4 < _targetLength2 / 3; _j4++) {
                    var cur = tripletGroups[_i36 + _j4];

                    if (_j4 > 0 && cur.rank !== tripletGroups[_i36 + _j4 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }
                  ...
                  if (_ok && tripletGroups[_i36].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i37 = 0; _i37 <= pairGroups.length - _targetLength3 / 2; _i37++) {
                  var _group30 = [];
                  var _ok2 = true;

                  for (var _j5 = 0; _j5 < _targetLength3 / 2; _j5++) {
                    var _cur = pairGroups[_i37 + _j5];

                    if (_j5 > 0 && _cur.rank !== pairGroups[_i37 + _j5 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }
                  ...
                  if (_ok2 && pairGroups[_i37].rank > _targetMin) {
        ...
        function getHintList(handCards, targetCards) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i38 = groupedCards.length - 1; _i38 >= 0; _i38--) {
                var _group31 = groupedCards[_i38];
            ...
            if (hintList.length === 0) {
              for (var _i39 = groupedCards.length - 1; _i39 >= 0; _i39--) {
                var _group32 = groupedCards[_i39];
        ...
        function findBombsWithHeartSupport(groups) {
          var result = [];
          var sortedGroups = [...groups].sort((a, b) => a.length - b.length); // 拆分红心级牌与其他组

          var redCards = sortedGroups.flat().filter(c => isHeartCard(c));
          var normalGroups = sortedGroups.filter(g => !g.some(c => isHeartCard(c)));
...
//# sourceMappingURL=c29ece2b3dd51f21a7fc70f8c5901ffe23c4f5f6.js.map