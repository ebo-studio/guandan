          ...
          if (this.outCardList.length == 1 && (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            while (checked < total) {
              ...
              if (hint.length === 1) {
                var card = hint[0];
                hintCard = card;
                var isPartOfCombo = false;

                for (var group of grouped) {
                  if (group.length > 1 && group.includes(card)) {
                    isPartOfCombo = true;
                    break;
                  }
                }
            ...
            if (!found && hintCard != null) {
              ...
              if (triples.length > 0) {
                ...
                var _card7 = tripleGroup[0];
                this.selectCardValue = [_card7];
                found = true;
...
//# sourceMappingURL=c2bbfb770b8c93c2167456bab379257b5dac6643.js.map