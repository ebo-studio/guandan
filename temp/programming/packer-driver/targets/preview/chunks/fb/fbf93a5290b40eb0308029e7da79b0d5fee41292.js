    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function findStraightByCard(cards) {
          ...
          for (var i = 0; i < cards.length; i++) {
            var r = getCardSize(cards[i]);
            var color = getCardColor(cards[i]);

            if (r === (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).cardInfo.levelCard && color === HONGTAO) {
...
//# sourceMappingURL=fbf93a5290b40eb0308029e7da79b0d5fee41292.js.map