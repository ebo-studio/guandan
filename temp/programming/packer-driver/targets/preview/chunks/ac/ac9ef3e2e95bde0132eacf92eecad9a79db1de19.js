        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          for (var s of straights) {
            ...
            if (isSameColorStraight) {
              ...
              // const firstCardColor = getCardColor(s[0]);
              // const isSameColor = s.every(card => getCardColor(card) === firstCardColor);
              // if (isSameColor) {
              // 将同花顺或逢人配放在最左边
              // }
              // else {
...
//# sourceMappingURL=ac9ef3e2e95bde0132eacf92eecad9a79db1de19.js.map