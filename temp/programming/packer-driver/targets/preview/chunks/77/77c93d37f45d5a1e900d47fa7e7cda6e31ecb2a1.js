    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getCardType(cards) {
          ...
          var bomArr = findBombsWithHeartCard(cards);

          if (bomArr[0].length >= 4) {
            if (bomArr[0].length == 4 || bomArr[0].length == 5) {
              return (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
                error: Error()
              }), GameDefine) : GameDefine).KIND_CARDS_BOMB_45;
            } else if (bomArr[0].length == 6) {
              return (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
                error: Error()
              }), GameDefine) : GameDefine).KIND_CARDS_BOMB_678; // 六炸
            }
          }
...
//# sourceMappingURL=77c93d37f45d5a1e900d47fa7e7cda6e31ecb2a1.js.map