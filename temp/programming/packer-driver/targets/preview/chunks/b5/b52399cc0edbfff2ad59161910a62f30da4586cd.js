  ...
  return {
    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        error: Error()
      }), CardAction) : CardAction), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(SpriteFrame), _dec14 = property(Sprite), _dec15 = property(SpriteFrame), _dec(_class = (_class2 = class CardLayer extends Component {
        constructor() {
          super(...arguments);
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            (function () {
              ...
              var sameSizeList = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getSameCardSizeList(value); // console.log("sameSizeList--> ",sameSizeList.length);
        ...
        onBtnCardDir() {
          ...
          var sorted = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            error: Error()
          }), GameLogic) : GameLogic).smartSortCards(this.handCardsValue); // this.setHandCards(sorted);
          ...
          var des = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).cardInfo.cardDir ? "确定切换为纵排!" : "确定切换为横排!";
          (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
          }), UIManager) : UIManager).Instace.showUI({
            path: (_crd && UIConfig === void 0 ? (_reportPossibleCrUseOfUIConfig({
            ...
            data: {
              ...
              okFunc: () => {
                (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                  error: Error()
                }), GlobalData) : GlobalData).cardInfo.cardDir = !(_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                  error: Error()
                }), GlobalData) : GlobalData).cardInfo.cardDir;
                this.showCardDir(true);
                this.init(false); // this.setHandCards(this.handCardsValue);
        ...
        smartSetHandCards(sortedCards) {
          ...
          var sameSizeList = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            error: Error()
          }), GameLogic) : GameLogic).getSameCardSizeList(sortedCards); // 每列一个点值

          this.initHandStartPosX_V(sameSizeList.length);
          var idx = 0;

          for (var i = 0; i < sameSizeList.length; i++) {
            var col = sameSizeList[i]; // 一列内的牌

            var posX = this.getHandCardPosX_V(i);

            for (var j = col.length - 1; j >= 0; j--) {
              var value = col[j];
              var card = this.getOneCard();
              card.node.setSiblingIndex(idx);
              var posY = this.getHandCardPosY_V(j);
        ...
        onStartHandCard(data) {
          ...
          this.setHandCards((_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            error: Error()
          }), GameLogic) : GameLogic).convertCardListS2C(data.cards), data.isOut >= 0);
          (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
            error: Error()
          }), utils) : utils).send((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
        ...
        onReviceCard(data, type) {
          if (type) {
            ...
            this.setHandCards(this.handCardsValue.concat(_card9), false, true);
            this.showBtnLayer(false);
          }
        }
...
//# sourceMappingURL=b52399cc0edbfff2ad59161910a62f30da4586cd.js.map