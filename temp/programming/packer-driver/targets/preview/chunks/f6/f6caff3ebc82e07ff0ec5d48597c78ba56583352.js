  ...
  return {
    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getHintCards(targetCards) {
          var hintList = [];
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              // 优先从散牌中找
              for (var i = this.groupedCards.length - 1; i >= 0; i--) {
                var group = this.groupedCards[i];
              ...
              if (hintList.length === 0) {
                for (var _i8 = this.groupedCards.length - 1; _i8 >= 0; _i8--) {
                  var _group4 = this.groupedCards[_i8];
...
//# sourceMappingURL=f6caff3ebc82e07ff0ec5d48597c78ba56583352.js.map