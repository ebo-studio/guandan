      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          for (var indexes of rankMap.values()) {
            ...
            for (var _i15 of indexes) {
              if (selectedIndexSet.has(_i15)) {
                selectedGroup.push(cards[_i15]);
              } else {
                unselectedGroup.push(cards[_i15]);
              }

              usedIndex.add(_i15); // 不管是否选中，都标记已使用
            }
        ...
        function getOneCardSizeList(value) {
          ...
          for (var _i16 = 0; _i16 < pairs.length; _i16++) {
            if (temp.length === 0) {
              temp.push(pairs[_i16]);
            } else {
              var last = getCardSize(temp[temp.length - 1][0]);
              var current = getCardSize(pairs[_i16][0]);
          ...
          var findStraightGroups = cards => {
            ...
            for (var _i17 = 0; _i17 < unique.length; _i17++) {
              var cur = unique[_i17];
        ...
        function getGroupPower(cards) {
          ...
          if (size >= 4 && size % 2 === 0) {
            ...
            for (var _i18 = 1; _i18 < pairs.length; _i18++) {
              if (pairs[_i18] !== pairs[_i18 - 1] + 1 || pairs[_i18] >= 15) return 0;
            }
        ...
        function findStraight_II(cards, usedIndex) {
          ...
          for (var _i19 = 0; _i19 < cards.length; _i19++) {
            if (usedIndex.has(_i19)) continue;
            var card = cards[_i19];
            var rank = card % 16;
            if (rank < 3 || rank > 13) continue; // 只允许 3~K 进入顺子

            if (!rankMap.has(rank)) rankMap.set(rank, []);
            rankMap.get(rank).push(_i19); // 保存的是索引，方便精确控制使用
          }
        ...
        function countThreeWithTwoAndStraight(unused) {
          ...
          for (var _i20 = 0; _i20 < unused.length; _i20++) {
            var _rank12 = getCardSize(unused[_i20]);

            if (_rank12 >= 3 && _rank12 <= 14 && !usedIndex.has(_i20)) {
              if (!rankToIndexes.has(_rank12)) rankToIndexes.set(_rank12, []);
              rankToIndexes.get(_rank12).push(_i20);
            }
          }
          ...
          for (var _i21 = 0; _i21 < sorted.length; _i21++) {
            var r = sorted[_i21];
        ...
        function getHintCards(targetCards, groupedCards) {
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i25 = result_three.length - 1; _i25 >= 0; _i25--) {
                var _group12 = result_three[_i25]; // if (group.length == 4) {
              ...
              for (var _i26 = result.length - 1; _i26 >= 0; _i26--) {
                var _group13 = result[_i26]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i27 = sameShunzi.length - 1; _i27 >= 0; _i27--) {
                var _group14 = sameShunzi[_i27];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i29 = groupedCards.length - 1; _i29 >= 0; _i29--) {
                var _group16 = groupedCards[_i29];
              ...
              for (var _i30 = groupedCards.length - 1; _i30 >= 0; _i30--) {
                var _group17 = groupedCards[_i30];
              ...
              for (var _i31 = groupedCards.length - 1; _i31 >= 0; _i31--) {
                var _group18 = groupedCards[_i31];
              ...
              for (var _i32 = result_three1.length - 1; _i32 >= 0; _i32--) {
                var _group19 = result_three1[_i32]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i33 = result1.length - 1; _i33 >= 0; _i33--) {
                var _group20 = result1[_i33]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i34 = sameShunzi1.length - 1; _i34 >= 0; _i34--) {
                var _group21 = sameShunzi1[_i34];
              ...
              for (var _i35 = groupedCards.length - 1; _i35 >= 0; _i35--) {
                var _group22 = groupedCards[_i35];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i36 = groupedCards.length - 1; _i36 >= 0; _i36--) {
                  var _group23 = groupedCards[_i36];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i39 = 0; _i39 <= sizes.length - 5; _i39++) {
                  var ok = true;

                  for (var _j2 = 1; _j2 < 5; _j2++) {
                    if (sizes[_i39 + _j2] !== sizes[_i39 + _j2 - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i40 = groupedCards.length - 1; _i40 >= 0; _i40--) {
                var _group26 = groupedCards[_i40];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop6 = function _loop6(_i41) {
                  var seq = allRanks.slice(_i41, _i41 + targetLength);
                ...
                for (var _i41 = 0; _i41 <= allRanks.length - targetLength; _i41++) {
                  var _ret6 = _loop6(_i41);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop7 = function _loop7(_i42) {
                  var seq = _allRanks.slice(_i42, _i42 + _targetLength);
                ...
                for (var _i42 = 0; _i42 <= _allRanks.length - _targetLength; _i42++) {
                  var _ret7 = _loop7(_i42);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i43 = 0; _i43 <= tripletGroups.length - _targetLength2 / 3; _i43++) {
                  var _group29 = [];
                  var _ok = true;

                  for (var _j4 = 0; _j4 < _targetLength2 / 3; _j4++) {
                    var cur = tripletGroups[_i43 + _j4];

                    if (_j4 > 0 && cur.rank !== tripletGroups[_i43 + _j4 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }
                  ...
                  if (_ok && tripletGroups[_i43].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i44 = 0; _i44 <= pairGroups.length - _targetLength3 / 2; _i44++) {
                  var _group30 = [];
                  var _ok2 = true;

                  for (var _j5 = 0; _j5 < _targetLength3 / 2; _j5++) {
                    var _cur = pairGroups[_i44 + _j5];

                    if (_j5 > 0 && _cur.rank !== pairGroups[_i44 + _j5 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }
                  ...
                  if (_ok2 && pairGroups[_i44].rank > _targetMin) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i45 = groupedCards.length - 1; _i45 >= 0; _i45--) {
                var _group31 = groupedCards[_i45];
            ...
            if (hintList.length === 0) {
              for (var _i46 = groupedCards.length - 1; _i46 >= 0; _i46--) {
                var _group32 = groupedCards[_i46];
            ...
            if (hintList.length === 0) {
              for (var _i47 = groupedCards.length - 1; _i47 >= 0; _i47--) {
                var _group33 = groupedCards[_i47];
...
//# sourceMappingURL=f6a1d2ac0a952d35d9bb7b25ef54b38765a695d8.js.map