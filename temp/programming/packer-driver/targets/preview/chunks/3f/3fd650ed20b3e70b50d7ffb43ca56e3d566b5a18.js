System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, AVirtualScrollView, GlobalData, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GameEndScoreRankPerson;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "aa5dezlT4dE14EpotGWIdDm", "GameEndScoreRankPerson", undefined);
      ...
      _export("GameEndScoreRankPerson", GameEndScoreRankPerson = (_dec = ccclass('GameEndScoreRankPerson'), _dec2 = property(_crd && AVirtualScrollView === void 0 ? (_reportPossibleCrUseOfAVirtualScrollView({
        error: Error()
      }), AVirtualScrollView) : AVirtualScrollView), _dec3 = property(Node), _dec(_class = (_class2 = class GameEndScoreRankPerson extends Component {
        constructor() {
          super(...arguments);
        ...
        setData() {
          var list = (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
...
//# sourceMappingURL=3fd650ed20b3e70b50d7ffb43ca56e3d566b5a18.js.map