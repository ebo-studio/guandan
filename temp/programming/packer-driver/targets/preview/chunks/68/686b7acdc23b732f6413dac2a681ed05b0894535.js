          ...
          if (data.hitCards && data.hitCards.length > 0) {
            ...
            for (var i = 0; i < data.hitCards.length; i++) {
              ...
              var hintCards = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getSameCardSizeList(handcardsValue, false); // var sameSizeList = GameLogic.sortCardsBySizeDown(this.handCardsValue, this.handCardsValue.length);
...
//# sourceMappingURL=686b7acdc23b732f6413dac2a681ed05b0894535.js.map