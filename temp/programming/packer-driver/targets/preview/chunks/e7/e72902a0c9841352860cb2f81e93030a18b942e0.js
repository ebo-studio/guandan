          ...
          $root.GameMsg = function () {
            ...
            GameMsg.UserList = function () {
              ...
              UserList.encode = function encode(message, writer) {
                ...
                if (message.list != null && message.list.length) for (var i = 0; i < message.list.length; ++i) {
                  $root.GameMsg.User.encode(message.list[i], writer.uint32(
                  /* id 1, wireType 2 =*/
                  10).fork()).ldelim();
                }
                return writer;
            ...
            GameMsg.Cards = function () {
              ...
              Cards.verify = function verify(message) {
                ...
                if (message.card != null && message.hasOwnProperty("card")) {
                  ...
                  for (var i = 0; i < message.card.length; ++i) {
                    if (!$util.isInteger(message.card[i])) return "card: integer[] expected";
                  }
                }
            ...
            GameMsg.Start = function () {
              ...
              Start.verify = function verify(message) {
                ...
                if (message.cards != null && message.hasOwnProperty("cards")) {
                  ...
                  for (var i = 0; i < message.cards.length; ++i) {
                    if (!$util.isInteger(message.cards[i])) return "cards: integer[] expected";
                  }
                }
            ...
            GameMsg.NextUser = function () {
              ...
              NextUser.encode = function encode(message, writer) {
                ...
                if (message.hitCards != null && message.hitCards.length) for (var i = 0; i < message.hitCards.length; ++i) {
                  $root.GameMsg.Cards.encode(message.hitCards[i], writer.uint32(
                  /* id 5, wireType 2 =*/
                  42).fork()).ldelim();
                }
                return writer;
            ...
            GameMsg.WinList = function () {
              ...
              WinList.encode = function encode(message, writer) {
                if (!writer) writer = $Writer.create();
                if (message.list != null && message.list.length) for (var i = 0; i < message.list.length; ++i) {
                  $root.GameMsg.ResUser.encode(message.list[i], writer.uint32(
                  /* id 1, wireType 2 =*/
                  10).fork()).ldelim();
                }
                if (message.type != null && message.hasOwnProperty("type")) writer.uint32(
            ...
            GameMsg.GongList = function () {
              ...
              GongList.encode = function encode(message, writer) {
                if (!writer) writer = $Writer.create();
                if (message.list != null && message.list.length) for (var i = 0; i < message.list.length; ++i) {
                  $root.GameMsg.Gong.encode(message.list[i], writer.uint32(
                  /* id 1, wireType 2 =*/
                  10).fork()).ldelim();
                }
                if (message.time != null && message.hasOwnProperty("time")) writer.uint32(
            ...
            GameMsg.UserCardsList = function () {
              ...
              UserCardsList.encode = function encode(message, writer) {
                if (!writer) writer = $Writer.create();
                if (message.list != null && message.list.length) for (var i = 0; i < message.list.length; ++i) {
                  $root.GameMsg.UserCards.encode(message.list[i], writer.uint32(
                  /* id 1, wireType 2 =*/
                  10).fork()).ldelim();
                }
                return writer;
...
//# sourceMappingURL=e72902a0c9841352860cb2f81e93030a18b942e0.js.map