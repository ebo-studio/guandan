    ...
    execute: function () {
      ...
      (function (_GameLogic) {
          ...
          switch (type) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i31 = groupedCards.length - 1; _i31 >= 0; _i31--) {
                  var _group25 = groupedCards[_i31];

                  if (_group25.length === 3) {
                    var size = GameLogic.getCardSize(_group25[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i33 = groupedCards.length - 1; _i33 >= 0; _i33--) {
                var _group26 = groupedCards[_i33];

                if (_group26.length >= 4) {
                  // ✅ 点数必须全部一致，才是炸弹
                  var isBomb = isSamePointWithFrp(_group26, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    error: Error()
                  }), GlobalData) : GlobalData).cardInfo.levelCard);
                  if (!isBomb) continue;
                  var groupRank = GameLogic.getCardSize(_group26[0]);

                  if (_group26.length > targetCards.length || _group26.length === targetCards.length && groupRank > targetMainSize) {
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i34 = 0; _i34 <= sizes.length - 5; _i34++) {
                  var ok = true;

                  for (var _j2 = 1; _j2 < 5; _j2++) {
                    if (sizes[_i34 + _j2] !== sizes[_i34 + _j2 - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
                  ...
                  if (ok) {
                    ...
                    for (var _j3 = 0; _j3 < 5; _j3++) {
                      var _s = sizes[_i34 + _j3];
                      var list = sizeMap.get(_s);

                      _group27.push(list.pop()); // 拿一张即可
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i35 = groupedCards.length - 1; _i35 >= 0; _i35--) {
                var _group28 = groupedCards[_i35];

                if (_group28.length >= 6) {
                  if (!isSamePointWithFrp(_group28, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    error: Error()
                  }), GlobalData) : GlobalData).cardInfo.levelCard)) continue;

                  var _groupRank = GameLogic.getCardSize(_group28[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop4 = function _loop4(_i36) {
                  var seq = allRanks.slice(_i36, _i36 + targetLength);
                  ...
                  if (isContinuous && seq[0] > targetStart) {
                    ...
                    for (var r of seq) {
                      _group29.push(rankMap.get(r).pop());
                    }
                ...
                for (var _i36 = 0; _i36 <= allRanks.length - targetLength; _i36++) {
                  var _ret4 = _loop4(_i36);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop5 = function _loop5(_i37) {
                  var seq = _allRanks.slice(_i37, _i37 + _targetLength);
                  ...
                  if (isContinuous && seq[0] > _targetStart) {
                    ...
                    for (var r of seq) {
                      _group30.push(_rankMap.get(r).pop());
                    }
                ...
                for (var _i37 = 0; _i37 <= _allRanks.length - _targetLength; _i37++) {
                  var _ret5 = _loop5(_i37);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i38 = 0; _i38 <= tripletGroups.length - _targetLength2 / 3; _i38++) {
                  var _group31 = [];
                  var _ok = true;

                  for (var _j4 = 0; _j4 < _targetLength2 / 3; _j4++) {
                    var cur = tripletGroups[_i38 + _j4];

                    if (_j4 > 0 && cur.rank !== tripletGroups[_i38 + _j4 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }

                    _group31.push(...cur.cards);
                  }

                  if (_ok && tripletGroups[_i38].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i39 = 0; _i39 <= pairGroups.length - _targetLength3 / 2; _i39++) {
                  var _group32 = [];
                  var _ok2 = true;

                  for (var _j5 = 0; _j5 < _targetLength3 / 2; _j5++) {
                    var _cur = pairGroups[_i39 + _j5];

                    if (_j5 > 0 && _cur.rank !== pairGroups[_i39 + _j5 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }

                    _group32.push(..._cur.cards);
                  }

                  if (_ok2 && pairGroups[_i39].rank > _targetMin) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i40 = groupedCards.length - 1; _i40 >= 0; _i40--) {
                var _group33 = groupedCards[_i40];

                if (_group33.length === 2) {
                  var card = _group33[0];
            ...
            if (hintList.length === 0) {
              for (var _i41 = groupedCards.length - 1; _i41 >= 0; _i41--) {
                ...
                if (_group34.length === 3) {
                  var _card10 = _group34[0];
            ...
            if (hintList.length === 0) {
              for (var _i42 = groupedCards.length - 1; _i42 >= 0; _i42--) {
                ...
                if (_group35.length >= 4) {
                  var bombs = GameLogic.newfindBombs(_group35);
            ...
            for (var _group36 of groupedCards) {
              if (_group36.length === 2 && GameLogic.getCardSize(_group36[0]) > targetRank) {
            ...
            var _loop6 = function _loop6(_group38) {
              if (_group38.length === 3 && GameLogic.getCardSize(_group38[0]) > targetRank) {
                // 找一个对子作为带牌
                var pair = groupedCards.find(g => g.length === 2 && g !== _group38);

                if (pair) {
                  hintList.push([..._group38, ...pair]);
                }
              }
            };
        ...
        function findBombsWithHeartSupport(groups) {
          var result = [];
          var heartGroup = groups.find(g => g.length === 1 && isHeartCard(g[0]));
          if (!heartGroup) return result;
          var heartCard = heartGroup[0];

          for (var group of groups) {
            if (group === heartGroup) continue;

            if (group.length === 3) {
              var merged = [...group, heartCard];
              var bombs = GameLogic.newfindBombs(merged);
...
//# sourceMappingURL=a0fad79e3a7d7c332c7ab873e6a5602d7d1dced5.js.map