    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          for (var _group2 of lianduiGroups) {
        ...
        function getCardType(cards) {
          ...
          if (cards.length >= 6 && cards.length % 2 === 0) {
            ...
            for (var _i5 = 1; _i5 < pairRanks.length; _i5++) {
              if (pairRanks[_i5] !== pairRanks[_i5 - 1] + 1) {
                return (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
                  error: Error()
                }), GameDefine) : GameDefine).KIND_CARDS_ERROR;
              }
...
//# sourceMappingURL=4092015b683e14d45233db0ecef71ac822122773.js.map