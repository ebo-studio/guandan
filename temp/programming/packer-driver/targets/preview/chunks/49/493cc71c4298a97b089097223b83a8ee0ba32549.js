        ...
        onBtnHint() {
          ...
          if (this.outCardList.length == 1 && ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            for (var i = 0; i < totalHints; i++) {
              ...
              if (!found) {
                var targetSize = hint[0] % 16; // 获取 hint 目标点数

                for (var _group of grouped) {
                  if (_group.length === 2) {
                    var groupSize = _group[0] % 16;

                    if (groupSize >= targetSize) {
                      this.selectCardValue = [_group[0]]; // 拆出一张
              ...
              if (!found) {
                var _targetSize = hint[0] % 16; // 获取 hint 目标点数


                for (var _group2 of grouped) {
                  if (_group2.length === 3) {
                    var _groupSize = _group2[0] % 16;

                    if (_groupSize >= _targetSize) {
                      this.selectCardValue = [_group2[0]]; // 拆出一张
...
//# sourceMappingURL=493cc71c4298a97b089097223b83a8ee0ba32549.js.map