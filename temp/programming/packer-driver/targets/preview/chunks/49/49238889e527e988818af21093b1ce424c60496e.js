    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getSameCardSizeList(value, keepOrder) {
          ...
          // // console.log("tmpList---> ", tmpList);
          // return tmpList;
          var source = keepOrder ? (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
            error: Error()
          }), utils) : utils).deepCopy(value) : sortCardsBySizeDown(value, value.length);
          var groups = new Map();

          for (var card of source) {
          ...
          if (!keepOrder) {
            ...
            result.sort((a, b) => {
              ...
              return getCardSize(b[0]) - getCardSize(a[0]);
            });
          }
...
//# sourceMappingURL=49238889e527e988818af21093b1ce424c60496e.js.map