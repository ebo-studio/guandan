      ...
      _export("Loading", Loading = (_dec = ccclass('Loading'), _dec2 = property(ProgressBar), _dec3 = property(Button), _dec(_class = (_class2 = class Loading extends Component {
        ...
        loadAllPrefabs() {
          ...
          return _asyncToGenerator(function* () {
            resources.loadDir('prefab', Prefab, /*#__PURE__*/_asyncToGenerator(function* (err, assets) {
              if (err) {
                console.error('加载 prefab 失败', err);
                return;
              }

              _this.total = assets.length;

              for (var asset of assets) {
                // ✅ 这里不再重新加载，只是模拟加载延迟
                yield _this.simulateDelay(10); // 可根据需求调整速度
        ...
        loadMainScene() {
          var sceneName = 'MainScene'; // director.preloadScene(sceneName, (completedCount, totalCount) => {
...
//# sourceMappingURL=260f6d1f23f3c6815f8cd8f642a77f50db8197f5.js.map