System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, Sprite, AItemRenderer, LobbyUserHeadItem, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, TeamLineItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "bbdd48r3QRDVK3AkGFtdjue", "TeamLineItem", undefined);
      ...
      _export("TeamLineItem", TeamLineItem = (_dec = ccclass('TeamLineItem'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(_crd && LobbyUserHeadItem === void 0 ? (_reportPossibleCrUseOfLobbyUserHeadItem({
        error: Error()
      }), LobbyUserHeadItem) : LobbyUserHeadItem), _dec(_class = (_class2 = class TeamLineItem extends (_crd && AItemRenderer === void 0 ? (_reportPossibleCrUseOfAItemRenderer({
        error: Error()
...
//# sourceMappingURL=62a94125b05accba9b450dc26cfabc2e900fd43b.js.map