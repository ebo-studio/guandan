      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected) {
          ...
          if (isThreeWithTwo) {
            (function () {
              // 👉 主动构造三带二组：先 3 后 2
              var threeWithTwoGroup = [...triple, ...pair]; // 顺序为：三张在前
              // ❗不要排序！保持顺序避免被拆分

              var threeWithTwoSet = new Set(threeWithTwoGroup);
              moveToBack.push(threeWithTwoGroup); // 从原有分组中移除三带二的牌
...
//# sourceMappingURL=7f41a84641b8b8c95b3f37012f81b5feed043b2f.js.map