            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var i = groupedCards.length - 1; i >= 0; i--) {
                ...
                if (group.length === 1) {
                  ...
                  if (GameLogic.getCardSize(card) > targetMainSize) {
                    hintList.push([card]);
                  }
                }
              } // 没找到，再从对子中拆一张
              ...
              if (hintList.length === 0) {
                for (var _i8 = groupedCards.length - 1; _i8 >= 0; _i8--) {
                  ...
                  if (_group4.length === 2) {
                    ...
                    if (GameLogic.getCardSize(_card3) > targetMainSize) {
...
//# sourceMappingURL=796a96f1657a1b18b728c368ca6589cc66b0e591.js.map