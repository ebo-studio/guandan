        ...
        function getHintCards(targetCards, groupedCards) {
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i17 = result.length - 1; _i17 >= 0; _i17--) {
                var _group11 = result[_i17]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);

                if (_group11.length != 0) {
              ...
              for (var _i18 = groupedCards.length - 1; _i18 >= 0; _i18--) {
                ...
                if (_group12.length == 5) {
                  var bombs = GameLogic.findFlushStraight(_group12);
              ...
              for (var _i19 = groupedCards.length - 1; _i19 >= 0; _i19--) {
                ...
                if (_group13.length == 6) {
                  var _bombs = GameLogic.newfindBombs(_group13);
...
//# sourceMappingURL=d7ca4dece5612f2c1c43954f4d0659a5dcc6a4f8.js.map