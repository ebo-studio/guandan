    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getHintCards(targetCards, groupedCards) {
          ...
          for (var _i20 = 0; _i20 < hintList.length; _i20++) {
            var lits = hintList[_i20];
        ...
        function printCardDetails(cards, isServer) {
          ...
          cards.forEach(card => {
            ...
            if (isServer) {
              console.log("\u670D\u52A1\u5668\u63D0\u793A\u7684Card: " + getCardColorByName(color) + " " + getCardRank(rank));
            }
          });
        }
...
//# sourceMappingURL=b7dab534450292f7f43025fcf1f347951565d0ad.js.map