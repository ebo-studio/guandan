    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          var moveToBack = [];
          var selectedSet = new Set(selected);
          var prevSet = new Set(prevSelected); // const usedCards = new Set<number>();

          var usedIndex = new Set();
          var selectedIndexSet = new Set();
          var selectedCardCount = new Map(); // for (const c of selected) {
          ...
          //     if (!group.some(c => usedIndex.has(c))) {
          //         result.push(group);
          //         group.forEach(c => usedIndex.add(c));
          //     }
          // }
          ...
          var triplets = findFeiji(selected.filter(c => !usedIndex.has(c)));

          for (var group of triplets) {
            moveToBack.push(group); // for (let i = 0; i < cards.length; i++) {
            //     if (group.includes(cards[i])) usedIndex.add(i);
            // }

            markUsedByCardValues(cards, group, usedIndex); // group.forEach(c => usedCards.add(c));
          ...
          var bombs = findBombsWithHeartCard(selected.filter(c => !usedIndex.has(c)));
          ...
          var straights = findStraightByCard(selected.filter(c => !usedIndex.has(c)));
          ...
          var lianduiGroups = findLiandui(selected.filter(c => !usedIndex.has(c)));
          ...
          for (var _group7 of lianduiGroups) {
            ...
            markUsedByCardValues(cards, _group7, usedIndex);
          } // ✅ 步骤7：识别两对


          if (selected.length == 2 || selected.length == 3) {
            var unusedCards = selected.filter(c => !usedIndex.has(c));
          ...
          var sortValue = cards.filter((_, idx) => !usedIndex.has(idx)); // ✅ 获取未使用的牌并按牌力降序排序
          ...
          for (var indexes of rankMap.values()) {
            ...
            for (var _i9 of indexes) {
              if (selectedIndexSet.has(_i9)) {
                selectedGroup.push(cards[_i9]);
              } else {
                unselectedGroup.push(cards[_i9]);
              }

              usedIndex.add(_i9); // 不管是否选中，都标记已使用
            }
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i16 = groupedCards.length - 1; _i16 >= 0; _i16--) {
                var _group8 = groupedCards[_i16];

                if (_group8.length === 2) {
                  var _card4 = _group8[0];
              ...
              for (var _i19 = result_three.length - 1; _i19 >= 0; _i19--) {
                var _group11 = result_three[_i19]; // if (group.length == 4) {
              ...
              for (var _i20 = result.length - 1; _i20 >= 0; _i20--) {
                var _group12 = result[_i20]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i22 = groupedCards.length - 1; _i22 >= 0; _i22--) {
                var _group14 = groupedCards[_i22];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i26 = result_three1.length - 1; _i26 >= 0; _i26--) {
                var _group18 = result_three1[_i26]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i27 = result1.length - 1; _i27 >= 0; _i27--) {
                var _group19 = result1[_i27]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i29 = groupedCards.length - 1; _i29 >= 0; _i29--) {
                var _group21 = groupedCards[_i29];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i32 = groupedCards.length - 1; _i32 >= 0; _i32--) {
                var _group23 = groupedCards[_i32];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i34 = groupedCards.length - 1; _i34 >= 0; _i34--) {
                var _group25 = groupedCards[_i34];
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i39 = groupedCards.length - 1; _i39 >= 0; _i39--) {
                var _group30 = groupedCards[_i39];
            ...
            var _loop8 = function _loop8(_group35) {
...
//# sourceMappingURL=f8a67e8f09eb2a62a5ce5fa4b6fa5b9ac1e9cd02.js.map