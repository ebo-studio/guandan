  ...
  return {
    ...
    execute: function () {
      ...
      _export("MessageBoxCommonTest", MessageBoxCommonTest = (_dec = ccclass('MessageBoxCommonTest'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class MessageBoxCommonTest extends (_crd && PopWindow === void 0 ? (_reportPossibleCrUseOfPopWindow({
        ...
        checkCode(num) {
          //重置
          for (var i = 0; i < this.btnNode1.children.length; i++) {
            var element = this.btnNode1.children[i];
          ...
          for (var _i = 0; _i < this.btnNode2.children.length; _i++) {
            var _element = this.btnNode2.children[_i];

            if (_element.getComponent(Button)) {
              if (_element.name == "Button" + num) {
                _element.getComponent(Sprite).color = new Color(255, 0, 0, 255);
              } else {
                _element.getComponent(Sprite).color = new Color(255, 255, 255, 255);
              }
            }
          }
        }
...
//# sourceMappingURL=fd499e6c38fb50d72697cec301028f670ebfe494.js.map