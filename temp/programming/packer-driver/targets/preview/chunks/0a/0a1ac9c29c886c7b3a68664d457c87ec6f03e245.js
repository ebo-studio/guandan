          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i14 = groupedCards.length - 1; _i14 >= 0; _i14--) {
                var _group10 = groupedCards[_i14];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i15 = groupedCards.length - 1; _i15 >= 0; _i15--) {
                var _group11 = groupedCards[_i15];
              ...
              for (var _i16 = groupedCards.length - 1; _i16 >= 0; _i16--) {
                var _group12 = groupedCards[_i16];
              ...
              for (var _i17 = groupedCards.length - 1; _i17 >= 0; _i17--) {
                var _group13 = groupedCards[_i17];
              ...
              for (var _i18 = groupedCards.length - 1; _i18 >= 0; _i18--) {
                var _group14 = groupedCards[_i18];
              ...
              for (var _i19 = groupedCards.length - 1; _i19 >= 0; _i19--) {
                var _group15 = groupedCards[_i19];
              ...
              for (var _i20 = groupedCards.length - 1; _i20 >= 0; _i20--) {
                var _group16 = groupedCards[_i20];
              ...
              for (var _i21 = groupedCards.length - 1; _i21 >= 0; _i21--) {
                var _group17 = groupedCards[_i21];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i22 = groupedCards.length - 1; _i22 >= 0; _i22--) {
                  var _group18 = groupedCards[_i22];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i25 = 0; _i25 <= sizes.length - 5; _i25++) {
                  var ok = true;

                  for (var _j2 = 1; _j2 < 5; _j2++) {
                    if (sizes[_i25 + _j2] !== sizes[_i25 + _j2 - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop2 = function _loop2(_i27) {
                  var seq = allRanks.slice(_i27, _i27 + targetLength);
                ...
                for (var _i27 = 0; _i27 <= allRanks.length - targetLength; _i27++) {
                  var _ret = _loop2(_i27);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop3 = function _loop3(_i28) {
                  var seq = _allRanks.slice(_i28, _i28 + _targetLength);
                ...
                for (var _i28 = 0; _i28 <= _allRanks.length - _targetLength; _i28++) {
                  var _ret2 = _loop3(_i28);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i29 = 0; _i29 <= tripletGroups.length - _targetLength2 / 3; _i29++) {
                  var _group24 = [];
                  var _ok = true;

                  for (var _j4 = 0; _j4 < _targetLength2 / 3; _j4++) {
                    var cur = tripletGroups[_i29 + _j4];

                    if (_j4 > 0 && cur.rank !== tripletGroups[_i29 + _j4 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }
                  ...
                  if (_ok && tripletGroups[_i29].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i30 = 0; _i30 <= pairGroups.length - _targetLength3 / 2; _i30++) {
                  var _group25 = [];
                  var _ok2 = true;

                  for (var _j5 = 0; _j5 < _targetLength3 / 2; _j5++) {
                    var _cur = pairGroups[_i30 + _j5];

                    if (_j5 > 0 && _cur.rank !== pairGroups[_i30 + _j5 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }
                  ...
                  if (_ok2 && pairGroups[_i30].rank > _targetMin) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i31 = groupedCards.length - 1; _i31 >= 0; _i31--) {
                var _group26 = groupedCards[_i31];
            ...
            if (hintList.length === 0) {
              for (var _i32 = groupedCards.length - 1; _i32 >= 0; _i32--) {
                var _group27 = groupedCards[_i32];
            ...
            if (hintList.length === 0) {
              for (var _i33 = groupedCards.length - 1; _i33 >= 0; _i33--) {
                var _group28 = groupedCards[_i33];
...
//# sourceMappingURL=0a1ac9c29c886c7b3a68664d457c87ec6f03e245.js.map