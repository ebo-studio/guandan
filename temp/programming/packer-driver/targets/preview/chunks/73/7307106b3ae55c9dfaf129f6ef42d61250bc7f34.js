            ...
            (function () {
              ...
              if (isOneCard) {
                _this.handCardsValue = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                  error: Error()
                }), GameLogic) : GameLogic).sortCardsBySizeDown(_this.handCardsValue, _this.handCardsValue.length);
                ...
                if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                  ...
                  sameSizeList = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                    error: Error()
                  }), GameLogic) : GameLogic).moveSelectedCardsToBack(value, _this.selectCardValue);
                  _this.handCardsValue = sameSizeList.flat();
                } else {
                  _this.handCardsValue = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                    error: Error()
                  }), GameLogic) : GameLogic).sortCardsBySizeDown(_this.handCardsValue, _this.handCardsValue.length);
...
//# sourceMappingURL=7307106b3ae55c9dfaf129f6ef42d61250bc7f34.js.map