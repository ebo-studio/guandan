        ...
        onHandleBtn(data) {
          ...
          if (data.hitCards && data.hitCards.length > 0) {
            if (!(_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              var hintList = []; // 从右往左找散牌（length === 1）

              for (var _i4 = this.groupedCards.length - 1; _i4 >= 0; _i4--) {
                var group = this.groupedCards[_i4];
              ...
              for (var _i5 = this.groupedCards.length - 1; _i5 >= 0; _i5--) {
                var _group = this.groupedCards[_i5];

                if (_group.length === 2) {
                  hintList.push([_group[0]]);
                }
              }
...
//# sourceMappingURL=647714bc171abe6c40c0a6cf09a8fb5651fadd37.js.map