    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          for (var _group9 of lianduiGroups) {
            moveToBack.push(_group9);

            _group9.forEach(c => usedCards.add(c));
          } // ✅ 步骤7：识别两对
          ...
          for (var [rank, _list2] of countMap.entries()) {
            if (_list2.length === 2) {
              moveToBack.push(_list2);

              _list2.forEach(c => usedCards.add(c));
            } else if (_list2.length === 3) {
              moveToBack.push(_list2);
          ...
          if (cards.length === 5) {
            ...
            if (triple.length === 3) {
              ...
              for (var red of redHeartList) {
                ...
                for (var [_rank6, _list3] of pairMap.entries()) {
                  if (_list3.length === 1) {
                    targetRank = _rank6;
                    break;
                  }
              ...
              for (var _list4 of pairMap.values()) {
                if (_list4.length >= 2) {
                  return (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
                    error: Error()
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i15 = groupedCards.length - 1; _i15 >= 0; _i15--) {
                var _group10 = groupedCards[_i15];

                if (_group10.length === 2) {
                  var _card5 = _group10[0];
              ...
              for (var _i17 = groupedCards.length - 1; _i17 >= 0; _i17--) {
                var _group12 = groupedCards[_i17];
              ...
              for (var _i18 = groupedCards.length - 1; _i18 >= 0; _i18--) {
                var _group13 = groupedCards[_i18];
              ...
              for (var _i19 = groupedCards.length - 1; _i19 >= 0; _i19--) {
                var _group14 = groupedCards[_i19];

                if (_group14.length == 5) {
                  var _bombs2 = GameLogic.findFlushStraight(_group14);
              ...
              for (var _i20 = groupedCards.length - 1; _i20 >= 0; _i20--) {
                var _group15 = groupedCards[_i20];

                if (_group15.length == 6) {
                  var _bombs3 = GameLogic.newfindBombs(_group15);
              ...
              for (var _i21 = groupedCards.length - 1; _i21 >= 0; _i21--) {
                ...
                if (_group16.length == 4) {
                  var _bombs4 = GameLogic.findRocket(_group16);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i24 = groupedCards.length - 1; _i24 >= 0; _i24--) {
                var _group19 = groupedCards[_i24];
              ...
              for (var _i25 = groupedCards.length - 1; _i25 >= 0; _i25--) {
                var _group20 = groupedCards[_i25];
              ...
              for (var _i26 = groupedCards.length - 1; _i26 >= 0; _i26--) {
                var _group21 = groupedCards[_i26];

                if (_group21.length == 5) {
                  var _bombs7 = GameLogic.findFlushStraight(_group21);
              ...
              for (var _i27 = groupedCards.length - 1; _i27 >= 0; _i27--) {
                var _group22 = groupedCards[_i27];

                if (_group22.length == 6) {
                  var _bombs8 = GameLogic.newfindBombs(_group22);
              ...
              for (var _i28 = groupedCards.length - 1; _i28 >= 0; _i28--) {
                var _group23 = groupedCards[_i28];

                if (_group23.length == 4) {
                  var _bombs9 = GameLogic.findRocket(_group23);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i29 = groupedCards.length - 1; _i29 >= 0; _i29--) {
                  var _group24 = groupedCards[_i29];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i33 = groupedCards.length - 1; _i33 >= 0; _i33--) {
                var _group27 = groupedCards[_i33];
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i38 = groupedCards.length - 1; _i38 >= 0; _i38--) {
                var _group32 = groupedCards[_i38];
            ...
            if (hintList.length === 0) {
              for (var _i39 = groupedCards.length - 1; _i39 >= 0; _i39--) {
                var _group33 = groupedCards[_i39];

                if (_group33.length === 3) {
                  var _card12 = _group33[0];
            ...
            if (hintList.length === 0) {
              for (var _i40 = groupedCards.length - 1; _i40 >= 0; _i40--) {
                var _group34 = groupedCards[_i40];
...
//# sourceMappingURL=6674b0b1432b8b98909852beb2513d3f2ddf0c74.js.map