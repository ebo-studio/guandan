System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, instantiate, Node, Prefab, Rect, sp, Sprite, SpriteAtlas, SpriteFrame, tween, UITransform, v3, Vec2, Vec3, CardItem, GameTimer, utils, GameLogic, GameEndType, GlobalData, SoundManager, PbManager, GameSocket, UIManager, UIConfig, CardAction, GameDefine, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _crd, ccclass, property, CardLayer;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        error: Error()
      }), CardAction) : CardAction), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(SpriteFrame), _dec14 = property(Sprite), _dec15 = property(Sprite), _dec16 = property(Sprite), _dec17 = property(Node), _dec18 = property(Node), _dec19 = property(Node), _dec20 = property(Node), _dec21 = property(Node), _dec(_class = (_class2 = class CardLayer extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "tonghuashunPic", _descriptor16, this);

          _initializerDefineProperty(this, "heitao", _descriptor17, this);

          _initializerDefineProperty(this, "fangkuai", _descriptor18, this);

          _initializerDefineProperty(this, "meihua", _descriptor19, this);

          _initializerDefineProperty(this, "hongtao", _descriptor20, this);
        ...
        init(reset) {
          ...
          this.cardsPosY = -this.halfWinHight + 58 + this.handCardsHeight * 0.5; // } else {
        ...
        setHandCards(value, ani, isUp, isOneCard) {
          ...
          var fushStraights = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
            error: Error()
          }), GameLogic) : GameLogic).findFlushStraightsWithHeartWildcard(this.handCardsValue);
          this.fangkuai.active = false;
          this.meihua.active = false;
          this.heitao.active = false;
          this.hongtao.active = false;

          for (var i = 0; i < fushStraights.length; i++) {
              ...
              if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                ...
                if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                  ...
                  if (isAuto) {
                    ...
                    sameSizeList = _this2.groupedCards; // GlobalData.cardInfo.sortCard = false;
                  } else {
                    _this2.groupedCards = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                      error: Error()
                    }), GameLogic) : GameLogic).removeOutCardsFromGrouped(_this2.groupedCards, tempCards);
        ...
        updateSelectedCards_V() {
          ...
          var isRecover = this.isSelectedRecoverGroup(this.selectCardIndex, this.handCardsValue, this.sorthandCardsValue);
        ...
        isSelectedRecoverGroup(selectCardIndex, cards, sorthandCardsValue) {
          var count = new Map();

          for (var v of sorthandCardsValue) {
            count.set(v, (count.get(v) || 0) + 1);
          }

          var groupedIndex = new Set();
          ...
          if ((this.outCardList.length == 1 || this.outCardList.length == 3) && ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            if (this.outCardList.length == 1 || this.outCardList.length == 2) {
              ...
              var _netHint = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getHintCards(this.outCardList, sameSizeList);
        ...
        onBtnCardDir() {
          ...
          if (cardType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (feijiType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              if (lianduiType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
                ...
                this.doHandCardPopDown_V(); // this.selectCardValue = [];
                // this.selectCardIndex = [];
                // this.selectedCardIndexSet.clear();
          ...
          this.groupedCards); // this.groupedCards = GameLogic.manualSortCards(
          //     selected,
        ...
        smartSetHandCards(sortedCards) {
          ...
          for (var _i4 = 0; _i4 < sameSizeList.length; _i4++) {
            var col = sameSizeList[_i4]; // 一列内的牌

            var posX = this.getHandCardPosX_V(_i4);
            ...
            for (var _j4 = col.length - 1; _j4 >= 0; _j4--) {
              ...
              card.setLastLine(_i4 === sameSizeList.length - 1);
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "tonghuashunPic", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "heitao", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "fangkuai", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, "meihua", [_dec20], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, "hongtao", [_dec21], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=439e55d5407e2bb6568491fb3851c858b8fe2bfd.js.map