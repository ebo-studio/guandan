              ...
              if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                ...
                if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                  ...
                  if (isAuto) {
                    _this2.groupedCards = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                      error: Error()
                    }), GameLogic) : GameLogic).removeOutCardsFromGrouped(_this2.groupedCards, tempCards); // GlobalData.cardInfo.sortCard = false;
                  } else {
                    _this2.groupedCards = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                      error: Error()
...
//# sourceMappingURL=6ce8ff5f6b55f527ae27aa2a5f37166fcdbc23ad.js.map