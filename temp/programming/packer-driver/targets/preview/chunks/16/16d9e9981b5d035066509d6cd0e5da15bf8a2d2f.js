      ...
      (function (_GameLogic) {
        ...
        function getCardType(cards) {
          ...
          if (cards.length == 5) {
            ...
            for (var _card2 of cards) {
              var _rank6 = getCardSize(_card2);

              if (_rank6 < 3 || _rank6 > 14) return (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
                error: Error()
              }), GameDefine) : GameDefine).KIND_CARDS_ERROR; // 不能包含2和王
        ...
        function getCardCountMap_I(cards) {
          ...
          for (var _card4 of heartCards) {
            ...
            var _loop3 = function _loop3(list, _rank7) {
              if (list.length < 4 && list.every(c => c % 16 === _rank7)) {
                // 仅补到点数一致的组
        ...
        function findFlushStraight(cards) {
          ...
          for (var [_color, colorCards] of colorMap.entries()) {
            ...
            for (var _card5 of colorCards) {
              var _rank9 = _card5 % 16;

              if (!rankMap.has(_rank9)) rankMap.set(_rank9, []);
              rankMap.get(_rank9).push(_card5);
            }
...
//# sourceMappingURL=16d9e9981b5d035066509d6cd0e5da15bf8a2d2f.js.map