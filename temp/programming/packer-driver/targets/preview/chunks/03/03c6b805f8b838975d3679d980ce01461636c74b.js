    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getOneCardSizeList(value) {
          ...
          var remainingPairs = pairs.filter(pair => !usedPairs.has(pair[0])); // 重组 tmpList：连对 + 剩余对子 + 其他

          tmpList.length = 0;
          tmpList.push(...lianDuiList);
          tmpList.push(...remainingPairs);
          tmpList.push(...otherGroups); // 🔽 排序：按权重（加入连对=45）
        ...
        function getGroupPower(cards) {
          ...
          if (size === 4 && isAllSameSize(cards)) return 60; // 连对判断：偶数张，都是对子，点数连续
...
//# sourceMappingURL=03c6b805f8b838975d3679d980ce01461636c74b.js.map