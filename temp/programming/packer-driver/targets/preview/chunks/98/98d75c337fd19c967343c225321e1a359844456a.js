            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              (function () {
                ...
                for (var _i = 0; _i < value.length; _i++) {
                  ...
                  if (tempGroup.length === 0 || (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                    error: Error()
                  }), GameLogic) : GameLogic).getCardSize(tempGroup[0]) === (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                    error: Error()
                  }), GameLogic) : GameLogic).getCardSize(cur)) {
                    tempGroup.push(cur);
                  } else {
                    sameSizeList.push(tempGroup);
                    tempGroup = [cur];
                  }
                }

                if (tempGroup.length > 0) sameSizeList.push(tempGroup);
...
//# sourceMappingURL=98d75c337fd19c967343c225321e1a359844456a.js.map