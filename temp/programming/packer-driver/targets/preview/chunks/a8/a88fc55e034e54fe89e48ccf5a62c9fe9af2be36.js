    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
          ...
          if (viewid == (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            (function () {
              ...
              var tmpInfo = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
              }), GameLogic) : GameLogic).getRemainCardsByDelete(_this2.handCardsValue, tempCards, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                error: Error()
              }), GlobalData) : GlobalData).cardInfo.sortCard, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                error: Error()
              }), GlobalData) : GlobalData).cardInfo.sortCard ? _this2.sorthandCardsValue : [], (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                error: Error()
              }), GlobalData) : GlobalData).cardInfo.sortCard ? _this2.prevSelected : []);
              ...
              console.log("出牌 cnt---> ", (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
                error: Error()
              }), utils) : utils).deepCopy(_this2.outCards[viewid].length)); //出牌动作
              ...
              if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                ...
                if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                  ...
                  sameSizeList = _this2.groupedCards; // 初始化布局

                  _this2.initHandStartPosX_V(sameSizeList.length);

                  var idx = 0;
                  var usedCardSet = new Set();
                  ...
                  var _loop3 = function _loop3(i) {
                    ...
                    var _loop4 = function _loop4(_j) {
                      var cardValue = list[_j]; // 找到未被使用的 CardItem（牌节点）

                      var _loop5 = function _loop5(n) {
                        var card = _this2.handCards[n];

                        if (card.getValue() === cardValue && !usedCardSet.has(card.getIndex())) {
                          usedCardSet.add(card.getIndex());
                          card.node.setSiblingIndex(idx);
                    ...
                    var _loop7 = function _loop7(_j2) {
                      ...
                      var _loop8 = function _loop8(n) {
                        ...
                        if (card.getValue() == valueSize && useIdxList.indexOf(card.getIndex()) == -1) {
                          ...
                          card.node.setSiblingIndex(_idx);
                          ...
                          var moveFunc = function moveFunc(posX, posY, idx) {
                            tween(card.node).delay(0.2).to(0.1, {
                              ...
                              if (_i == sameSizeList.length - 1 && _j2 == 0) {
                                that.setCanTouch(true);
                              }
                            }).start();
                          };

                          moveFunc(posX, posY, _idx);
                          _idx++;
                          return "break";
                        }
                      };
        ...
        updateSelectedCards_V() {
          ...
          this.picHuifuDir.node.active = isRecover; // GlobalData.cardInfo.cardDir = isRecover;
        ...
        showCardDir(show) {
          ...
          this.picHuifuDir.node.active = false; // if (show) {
...
//# sourceMappingURL=a88fc55e034e54fe89e48ccf5a62c9fe9af2be36.js.map