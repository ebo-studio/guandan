            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i14 = groupedCards.length - 1; _i14 >= 0; _i14--) {
                ...
                if (_group9.length >= 4) {
                  ...
                  if (_group9.length > targetCards.length || _group9.length === targetCards.length && _groupRank > targetMainSize) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i16 = groupedCards.length - 1; _i16 >= 0; _i16--) {
                ...
                if (_group11.length >= 6) {
                  var _groupRank2 = GameLogic.getCardSize(_group11[0]);

                  if (_groupRank2 > targetMainSize) {
...
//# sourceMappingURL=59def5424c69528f45f232ae4108055cd10ff046.js.map