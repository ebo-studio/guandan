    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        updateSelectedCards_V() {
          ...
          var isRecover = this.isRecoverGroupPartialMatch(this.handCardsValue, this.sorthandCardsValue, 1, this.selectCardValue);
        ...
        selected) {
          ...
          var groupedIndexes = new Set();
          var groupedOffset = 0;
          var usedGlobal = new Set();

          for (var size of groupSizes) {
            var group = grouped.slice(groupedOffset, groupedOffset + size);
            groupedOffset += size;
            var groupCount = new Map();

            for (var _val of group) {
              groupCount.set(_val, (groupCount.get(_val) || 0) + 1);
            }

            for (var _i3 = 0; _i3 < cards.length; _i3++) {
              if (usedGlobal.has(_i3)) continue;
              var _c = cards[_i3];

              if ((groupCount.get(_c) || 0) > 0) {
                groupedIndexes.add(_i3);
                groupCount.set(_c, groupCount.get(_c) - 1);
                usedGlobal.add(_i3);
              }
            }
...
//# sourceMappingURL=2d0420b38393b091c31a536ad1f2d64191d68cca.js.map