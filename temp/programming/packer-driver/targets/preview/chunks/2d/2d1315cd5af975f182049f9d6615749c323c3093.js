          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i19 = groupedCards.length - 1; _i19 >= 0; _i19--) {
                ...
                if (_group13.length == 4) {
                  var _bombs = GameLogic.findRocket(_group13);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i20 = groupedCards.length - 1; _i20 >= 0; _i20--) {
                ...
                if (_group14.length === 2) {
                  var _card5 = _group14[0];
              ...
              for (var _i21 = groupedCards.length - 1; _i21 >= 0; _i21--) {
                ...
                if (_group15.length === 3) {
                  var _card6 = _group15[0];
              ...
              for (var _i22 = groupedCards.length - 1; _i22 >= 0; _i22--) {
                ...
                if (_group16.length == 4) {
                  var _bombs2 = GameLogic.newfindBombs(_group16);
              ...
              for (var _i24 = groupedCards.length - 1; _i24 >= 0; _i24--) {
                ...
                if (_group18.length == 5) {
                  var _bombs4 = GameLogic.findFlushStraight(_group18);
              ...
              for (var _i25 = groupedCards.length - 1; _i25 >= 0; _i25--) {
                ...
                if (_group19.length == 6) {
                  var _bombs5 = GameLogic.newfindBombs(_group19);
              ...
              for (var _i26 = groupedCards.length - 1; _i26 >= 0; _i26--) {
                ...
                if (_group20.length == 4) {
                  var _bombs6 = GameLogic.findRocket(_group20);
              ...
              for (var _i27 = result1.length - 1; _i27 >= 0; _i27--) {
                var _group21 = result1[_i27]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i28 = groupedCards.length - 1; _i28 >= 0; _i28--) {
                  ...
                  if (_group22.length === 3) {
                    var size = GameLogic.getCardSize(_group22[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i30 = groupedCards.length - 1; _i30 >= 0; _i30--) {
                ...
                if (_group23.length >= 4) {
                  // ✅ 点数必须全部一致，才是炸弹
                  var isBomb = isSamePointWithFrp(_group23, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    error: Error()
                  }), GlobalData) : GlobalData).cardInfo.levelCard);
                  if (!isBomb) continue;
                  var groupRank = GameLogic.getCardSize(_group23[0]);

                  if (_group23.length > targetCards.length || _group23.length === targetCards.length && groupRank > targetMainSize) {
              ...
              for (var cards of colorGroups.values()) {
                ...
                for (var _i31 = 0; _i31 <= sizes.length - 5; _i31++) {
                  var ok = true;

                  for (var _j2 = 1; _j2 < 5; _j2++) {
                    if (sizes[_i31 + _j2] !== sizes[_i31 + _j2 - 1] + 1) {
                      ok = false;
                      break;
                    }
                  }
                  ...
                  if (ok) {
                    ...
                    for (var _j3 = 0; _j3 < 5; _j3++) {
                      var _s = sizes[_i31 + _j3];
                      var list = sizeMap.get(_s);

                      _group24.push(list.pop()); // 拿一张即可
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i32 = groupedCards.length - 1; _i32 >= 0; _i32--) {
                var _group25 = groupedCards[_i32];

                if (_group25.length >= 6) {
                  if (!isSamePointWithFrp(_group25, (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
                    error: Error()
                  }), GlobalData) : GlobalData).cardInfo.levelCard)) continue;

                  var _groupRank = GameLogic.getCardSize(_group25[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop4 = function _loop4(_i33) {
                  var seq = allRanks.slice(_i33, _i33 + targetLength);
                  ...
                  if (isContinuous && seq[0] > targetStart) {
                    ...
                    for (var r of seq) {
                      _group26.push(rankMap.get(r).pop());
                    }
                ...
                for (var _i33 = 0; _i33 <= allRanks.length - targetLength; _i33++) {
                  var _ret4 = _loop4(_i33);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop5 = function _loop5(_i34) {
                  var seq = _allRanks.slice(_i34, _i34 + _targetLength);
                  ...
                  if (isContinuous && seq[0] > _targetStart) {
                    ...
                    for (var r of seq) {
                      _group27.push(_rankMap.get(r).pop());
                    }
                ...
                for (var _i34 = 0; _i34 <= _allRanks.length - _targetLength; _i34++) {
                  var _ret5 = _loop5(_i34);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_3:
              {
                ...
                for (var _i35 = 0; _i35 <= tripletGroups.length - _targetLength2 / 3; _i35++) {
                  var _group28 = [];
                  var _ok = true;

                  for (var _j4 = 0; _j4 < _targetLength2 / 3; _j4++) {
                    var cur = tripletGroups[_i35 + _j4];

                    if (_j4 > 0 && cur.rank !== tripletGroups[_i35 + _j4 - 1].rank + 1) {
                      _ok = false;
                      break;
                    }

                    _group28.push(...cur.cards);
                  }

                  if (_ok && tripletGroups[_i35].rank > targetMin) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_2:
              {
                ...
                for (var _i36 = 0; _i36 <= pairGroups.length - _targetLength3 / 2; _i36++) {
                  var _group29 = [];
                  var _ok2 = true;

                  for (var _j5 = 0; _j5 < _targetLength3 / 2; _j5++) {
                    var _cur = pairGroups[_i36 + _j5];

                    if (_j5 > 0 && _cur.rank !== pairGroups[_i36 + _j5 - 1].rank + 1) {
                      _ok2 = false;
                      break;
                    }

                    _group29.push(..._cur.cards);
                  }

                  if (_ok2 && pairGroups[_i36].rank > _targetMin) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i37 = groupedCards.length - 1; _i37 >= 0; _i37--) {
                var _group30 = groupedCards[_i37];

                if (_group30.length === 2) {
                  var card = _group30[0];
            ...
            if (hintList.length === 0) {
              for (var _i38 = groupedCards.length - 1; _i38 >= 0; _i38--) {
                ...
                if (_group31.length === 3) {
                  var _card10 = _group31[0];
            ...
            if (hintList.length === 0) {
              for (var _i39 = groupedCards.length - 1; _i39 >= 0; _i39--) {
                ...
                if (_group32.length >= 4) {
                  var bombs = GameLogic.newfindBombs(_group32);
            ...
            for (var _group33 of groupedCards) {
              if (_group33.length === 2 && GameLogic.getCardSize(_group33[0]) > targetRank) {
            ...
            for (var _group34 of groupedCards) {
              if (_group34.length === 3 && GameLogic.getCardSize(_group34[0]) > targetRank) {
            ...
            var _loop6 = function _loop6(_group35) {
              if (_group35.length === 3 && GameLogic.getCardSize(_group35[0]) > targetRank) {
                // 找一个对子作为带牌
                var pair = groupedCards.find(g => g.length === 2 && g !== _group35);

                if (pair) {
                  hintList.push([..._group35, ...pair]);
                }
              }
            };
...
//# sourceMappingURL=2d1315cd5af975f182049f9d6615749c323c3093.js.map