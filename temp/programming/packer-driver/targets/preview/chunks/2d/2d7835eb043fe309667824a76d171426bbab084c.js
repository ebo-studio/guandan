    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getCardTypeByFeiji(cards) {
          ...
          var _loop3 = function _loop3(card) {
            var rank = getCardSize(card);
        ...
        function countThreeWithTwoAndStraight(unused) {
          ...
          for (var _i14 = 0; _i14 < unused.length; _i14++) {
            var _rank12 = getCardSize(unused[_i14]);

            if (_rank12 >= 3 && _rank12 <= 14 && !usedIndex.has(_i14)) {
              if (!rankToIndexes.has(_rank12)) rankToIndexes.set(_rank12, []);
              rankToIndexes.get(_rank12).push(_i14);
            }
          }
          ...
          switch (type) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop6 = function _loop6(_i36) {
        ...
        function getHintList(handCards, targetCards) {
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            var _loop7 = function _loop7(_group36) {
        ...
        function findFlushStraightWithHeart(groups) {
          ...
          for (var [_color2, cards] of colorMap.entries()) {
            ...
            var _loop8 = function _loop8(seq) {
              var group = [];
              var usedRed = new Set();
...
//# sourceMappingURL=2d7835eb043fe309667824a76d171426bbab084c.js.map