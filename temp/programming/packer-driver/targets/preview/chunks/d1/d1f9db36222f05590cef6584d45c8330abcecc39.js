    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              ...
              (function () {
                ...
                if (temp.length > 0) groupList.push(temp);

                _this.initHandStartPosX_V(groupList.length);

                var _loop2 = function _loop2(_i2) {
                  var list = groupList[_i2];
                  ...
                  var _loop3 = function _loop3(j) {
                    ...
                    var posY = _this.getHandCardPosY_V(list.length - 1 - j);

                    card.node.scale = new Vec3(_this.handScale, _this.handScale, _this.handScale);

                    var cardSps = _this.getCardsSprite(value);
                    ...
                    if (ani && _i2 === groupList.length - 1 && j === 0) {
                      card.setBack(true);
                    }
                    ...
                    card.setIndex(idx);
                    card.setBottom(j === 0);
                    card.setLastLine(_i2 === groupList.length - 1);
                    idx++;
                ...
                for (var _i2 = 0; _i2 < groupList.length; _i2++) {
                  _loop2(_i2);
                }
              })();
            } else {
              (function () {
                ...
                var _loop4 = function _loop4(_i3) {
                  var list = sameSizeList[_i3];

                  var posX = _this.getHandCardPosX_V(_i3);
                  ...
                  var _loop5 = function _loop5(j) {
                    ...
                    if (ani) {
                      if (_i3 == sameSizeList.length - 1 && j == 0) {
                        card.setBack(true);
                        tmpIdx = idx;
                      }
                    }
                    ...
                    var moveFunc = function moveFunc(posX, posY, tmpIdx) {
                      if (ani) {
                        card.node.setPosition(v3(0, 0, 0));
                        tween(card.node).delay(_i3 * delayTime).call(() => {
                          if (tmpIdx == idx - 1) {
                            card.setBack(false);
                            that.setCanTouch(true);
                          }
        ...
        onScreenTouchMove(event) {
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            for (var _i6 = this.handCards.length - 1; _i6 >= 0; _i6--) {
              var _item = this.handCards[_i6].node;
              ...
              if (_item != null) {
                ...
                var tmpPosXR = this.handCards[_i6].getLastLine() ? posXR : posXL + this.handDistance_V; //右边界点

                var tmpPosY = this.handCards[_i6].getBottom() ? _posyYB : _posY - this.cardDistance_V; //下边界点
                ...
                if (leftUp || leftDown || rightUp || rightDown) {
                  this.handCards[_i6].setMask(true);
                } else {
                  this.handCards[_i6].setMask(false);
                }
              }
            } //第一张
            ...
            for (var _i8 = this.handCards.length - 1; _i8 >= 0; _i8--) {
              var _card8 = this.handCards[_i8];
        ...
        smartSetHandCards(sortedCards) {
          ...
          for (var _i9 = 0; _i9 < sameSizeList.length; _i9++) {
            var col = sameSizeList[_i9]; // 一列内的牌

            var posX = this.getHandCardPosX_V(_i9);
            ...
            for (var _j5 = col.length - 1; _j5 >= 0; _j5--) {
              ...
              card.setLastLine(_i9 === sameSizeList.length - 1);
...
//# sourceMappingURL=d1f9db36222f05590cef6584d45c8330abcecc39.js.map