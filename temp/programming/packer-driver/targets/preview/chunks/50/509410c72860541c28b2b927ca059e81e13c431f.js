    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function findBombsByCount(cards, count) {
          ...
          for (var [_rank3, group] of map.entries()) {
        ...
        function findFlushStraight(cards) {
          ...
          for (var [_color, colorCards] of colorMap.entries()) {
            ...
            for (var _card2 of colorCards) {
              var _rank4 = _card2 % 16;

              if (!rankMap.has(_rank4)) rankMap.set(_rank4, []);
              rankMap.get(_rank4).push(_card2);
            }
          ...
          while (i <= ranks.length - 5) {
            ...
            if (length == 5) {
              ...
              for (var _rank5 of seq) {
                var cardsOfRank = map.get(_rank5);
          ...
          while (i <= sortedRanks.length - 5) {
            ...
            if (isConsecutive) {
              ...
              for (var _rank6 of seq) {
                var available = rankMap.get(_rank6).filter(idx => !usedIndex.has(idx));
        ...
        function countThreeWithTwoAndStraight(unused) {
          ...
          for (var _i13 = 0; _i13 < unused.length; _i13++) {
            var _rank7 = getCardSize(unused[_i13]);

            if (_rank7 >= 3 && _rank7 <= 14 && !usedIndex.has(_i13)) {
              if (!rankToIndexes.has(_rank7)) rankToIndexes.set(_rank7, []);
              rankToIndexes.get(_rank7).push(_i13);
            }
          }
        ...
        function newfindBombs(cards, levelRank) {
          ...
          for (var _rank9 of sortedRanks) {
            var group = countMap.get(_rank9);
...
//# sourceMappingURL=509410c72860541c28b2b927ca059e81e13c431f.js.map