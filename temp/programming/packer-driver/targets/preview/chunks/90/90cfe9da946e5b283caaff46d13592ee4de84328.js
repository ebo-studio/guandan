    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function isFengRenPeiSorted(cards) {
          ...
          var ranks = Array.from(new Set(cards.filter(c => !isHeartCard(c)).map(c => c % 16).filter(r => r >= 3 && r <= 13))).sort((a, b) => a - b);
          ...
          for (var s of straights) {
            ...
            if (isSameColorStraight) {
              (function () {
                ...
                var firstCardColor = getCardColor(s[0]);
                var isSameColor = s.every(card => getCardColor(card) === firstCardColor);
...
//# sourceMappingURL=90cfe9da946e5b283caaff46d13592ee4de84328.js.map