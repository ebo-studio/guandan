    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function smartSortCards(cards) {
          ...
          findBombsByCount(getUnused(), 4).forEach(g => pushAndMark(g)); // 5. 对子

          findPair(getUnused()).forEach(g => pushAndMark(g)); // 6. 单张

          getUnused().forEach(c => pushAndMark([c])); // ------- 以下为杂牌型，最后追加 -------
          // 飞机（不带）
...
//# sourceMappingURL=5fd320b7b574632acf7de53542c94409f8b842ea.js.map