        ...
        onHandleBtn(data) {
          ...
          if (data.hitCards && data.hitCards.length > 0) {
            ...
            for (var i = 0; i < data.hitCards.length; i++) {
              hintCards.push((_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
                error: Error()
            ...
            (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
              error: Error()
            }), GameLogic) : GameLogic).printCardDetails(hintCards, true); // if (this.outCardList.length != 0) {
...
//# sourceMappingURL=5f557e300d137110a78286263ee49e953e1ff1a2.js.map