    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        updateSelectedCards_V() {
          ...
          var isRecover = false;
          var selectedSet = new Set(this.selectCardValue);
          ...
          (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            error: Error()
          }), GlobalData) : GlobalData).cardInfo.cardDir = isRecover;
          this.showCardDir(true); // console.log("this.selectCardValue---> ", this.selectCardValue);
        ...
        onBtnCardDir() {
          ...
          var isUndo = this.groupedCards.some(group => group.some(card => selected.includes(card)));

          if (isUndo) {
            this.sorthandCardsValue = this.sorthandCardsValue.filter(c => !selected.includes(c));
          } else {
...
//# sourceMappingURL=53a99b1afdf0e81772a1bb0807372c284ca739db.js.map