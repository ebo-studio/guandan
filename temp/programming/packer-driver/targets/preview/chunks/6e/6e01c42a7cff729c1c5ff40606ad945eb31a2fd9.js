    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function findStraightByCard(cards) {
          ...
          seqList.push([10, 11, 12, 13, 1]); // 特殊顺子：TJQKA
          ...
          var _loop = function _loop(seq) {
            ...
            for (var _r of seq) {
              ...
              if (available !== undefined) {
                ...
                // ❗缺牌，尝试用红心补
                var red = heartIndexes.find(i => !usedIndexes.has(i) && !usedThisGroup.has(i));
...
//# sourceMappingURL=6e01c42a7cff729c1c5ff40606ad945eb31a2fd9.js.map