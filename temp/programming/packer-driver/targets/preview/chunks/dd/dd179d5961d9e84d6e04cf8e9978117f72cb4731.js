      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected) {
          ...
          if (isThreeWithTwo) {
            ...
            // 原逻辑：把选中的放到后面
            for (var _group of tmpList) {
              if (_group.some(card => selected.includes(card))) {
...
//# sourceMappingURL=dd179d5961d9e84d6e04cf8e9978117f72cb4731.js.map