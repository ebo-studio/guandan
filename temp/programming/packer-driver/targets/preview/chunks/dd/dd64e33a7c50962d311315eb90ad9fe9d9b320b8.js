      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        setHandCards(value, ani, isUp) {
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            this.handCardsValue = (_crd && GameLogic === void 0 ? (_reportPossibleCrUseOfGameLogic({
              error: Error()
            }), GameLogic) : GameLogic).autoSortCards(this.handCardsValue);
            this.sortAllCards(); // // this.handCardsValue = GameLogic.sortCardsBySizeDown(this.handCardsValue, this.handCardsValue.length);
        ...
        onScreenTouchMove(event) {
          ...
          if ((_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
            ...
            for (var _i3 = this.handCards.length - 1; _i3 >= 0; _i3--) {
              var _item = this.handCards[_i3].node;
              ...
              if (_item != null) {
                ...
                var tmpPosXR = this.handCards[_i3].getLastLine() ? posXR : posXL + this.handDistance_V; //右边界点

                var tmpPosY = this.handCards[_i3].getBottom() ? _posyYB : _posY - this.cardDistance_V; //下边界点
                ...
                if (leftUp || leftDown || rightUp || rightDown) {
                  this.handCards[_i3].setMask(true);
                } else {
                  this.handCards[_i3].setMask(false);
                }
              }
            } //第一张
...
//# sourceMappingURL=dd64e33a7c50962d311315eb90ad9fe9d9b320b8.js.map