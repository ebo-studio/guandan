    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function smartSortCards(cards) {
          ...
          findThreeWithTwo(getUnused()).forEach(g => pushAndMark(g, false)); // 飞机（不带）

          findPlane(getUnused()).forEach(g => pushAndMark(g, false)); // 连对

          findChainPairs(getUnused()).forEach(g => pushAndMark(g, false)); // 顺子

          findStraight(getUnused()).forEach(g => pushAndMark(g, false)); // 5. 对子
...
//# sourceMappingURL=b6f32d402a2550970cd6c2818c8ae5e325840067.js.map