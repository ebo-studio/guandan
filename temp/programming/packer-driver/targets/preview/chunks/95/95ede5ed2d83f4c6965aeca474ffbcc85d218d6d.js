    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function findBombsByCount(cards, count) {
          var map = new Map();
          var result = []; // 找红桃级牌（逢人配牌）

          var frpCards = cards.filter(card => {
            var rank = card % 16;
            var color = Math.floor(card / 16);
            return rank === (_crd && GlobalData === void 0 ? (_reportPossibleCrUseOfGlobalData({
              error: Error()
            }), GlobalData) : GlobalData).cardInfo.levelCard && color === 2; // 红桃级牌
          });
          var remainCards = cards.filter(card => !frpCards.includes(card));

          for (var card of remainCards) {
            var rank = card % 16;
          ...
          if (count === 4 && frpCards.length > 0) {
            for (var _group4 of map.values()) {
              if (_group4.length === 3) {
                for (var frp of frpCards) {
                  result.push([..._group4, frp]);
                }
              }
            }
          }
          ...
          switch (type) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i11 = groupedCards.length - 1; _i11 >= 0; _i11--) {
                ...
                if (_group8.length === 2) {
                  if (GameLogic.getCardSize(_group8[0]) > targetMainSize) {
                    hintList.push([..._group8]); // 复制一个对子
                  }
                }
              }
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i12 = groupedCards.length - 1; _i12 >= 0; _i12--) {
                  var _group9 = groupedCards[_i12];

                  if (_group9.length === 3) {
                    var size = GameLogic.getCardSize(_group9[0]);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i14 = groupedCards.length - 1; _i14 >= 0; _i14--) {
                ...
                if (_group10.length >= 4) {
                  var groupRank = GameLogic.getCardSize(_group10[0]);

                  if (_group10.length > targetCards.length || _group10.length === targetCards.length && groupRank > targetMainSize) {
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i16 = groupedCards.length - 1; _i16 >= 0; _i16--) {
                ...
                if (_group12.length >= 6) {
                  var _groupRank = GameLogic.getCardSize(_group12[0]);
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_SHUNZI_1:
              {
                ...
                var _loop2 = function _loop2(_i17) {
                  ...
                  if (isContinuous && seq[0] > targetStart) {
                    ...
                    for (var r of seq) {
                      _group13.push(rankMap.get(r).pop());
                    }
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_COLOR:
              {
                ...
                var _loop3 = function _loop3(_i18) {
                  ...
                  if (isContinuous && seq[0] > _targetStart) {
                    ...
                    for (var r of seq) {
                      _group14.push(_rankMap.get(r).pop());
                    }
...
//# sourceMappingURL=95ede5ed2d83f4c6965aeca474ffbcc85d218d6d.js.map