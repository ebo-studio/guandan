    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          var countMap = getCardCountMap(unusedCards);
          var pairList = [];
        ...
        function findFlushStraight(cards) {
          ...
          for (var [_color, colorCards] of colorMap.entries()) {
            ...
            for (var _card4 of colorCards) {
              var _rank7 = _card4 % 16;

              if (!rankMap.has(_rank7)) rankMap.set(_rank7, []);
              rankMap.get(_rank7).push(_card4);
            }
...
//# sourceMappingURL=095eb01fff03a0fe709bcd56754ed98188da3d6b.js.map