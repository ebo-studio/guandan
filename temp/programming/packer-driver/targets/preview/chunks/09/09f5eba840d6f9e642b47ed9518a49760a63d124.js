  ...
  return {
    ...
    execute: function () {
      ...
      (function (_GameLogic) {
        ...
        function getHintCards(targetCards, groupedCards) {
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              var result = tryMergeBomb(groupedCards);
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i26 = groupedCards.length - 1; _i26 >= 0; _i26--) {
                ...
                if (_group20.length == 5) {
                  var _bombs7 = GameLogic.newfindBombs(_group20);
              ...
              for (var _i27 = groupedCards.length - 1; _i27 >= 0; _i27--) {
                ...
                if (_group21.length == 5) {
                  var _bombs8 = GameLogic.findFlushStraight(_group21);
              ...
              for (var _i28 = groupedCards.length - 1; _i28 >= 0; _i28--) {
                ...
                if (_group22.length == 6) {
                  var _bombs9 = GameLogic.newfindBombs(_group22);
              ...
              for (var _i29 = groupedCards.length - 1; _i29 >= 0; _i29--) {
                ...
                if (_group23.length == 4) {
                  var _bombs10 = GameLogic.findRocket(_group23);
        ...
        function tryMergeBomb(grouped) {
          // 合并所有小组为一个大数组
          var merged = grouped.flat(); // 调用已有的支持红心级牌的炸弹检测方法

          var bombs = GameLogic.newfindBombs(merged); // 如果找到合法炸弹，返回第一组
...
//# sourceMappingURL=09f5eba840d6f9e642b47ed9518a49760a63d124.js.map