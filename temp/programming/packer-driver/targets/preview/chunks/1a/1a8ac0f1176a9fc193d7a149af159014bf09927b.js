      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          for (var _i15 = 0; _i15 < cards.length; _i15++) {
            if (usedIndex.has(_i15)) continue;

            var _rank5 = getCardSize(cards[_i15]);

            if (!rankMap.has(_rank5)) rankMap.set(_rank5, []);
            rankMap.get(_rank5).push(_i15);
          }
...
//# sourceMappingURL=1a8ac0f1176a9fc193d7a149af159014bf09927b.js.map