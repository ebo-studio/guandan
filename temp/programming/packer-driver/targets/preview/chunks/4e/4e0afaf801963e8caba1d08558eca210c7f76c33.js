    ...
    execute: function () {
      ...
      _export("CardLayer", CardLayer = (_dec = ccclass('CardLayer'), _dec2 = property(Prefab), _dec3 = property(SpriteAtlas), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(_crd && GameTimer === void 0 ? (_reportPossibleCrUseOfGameTimer({
        ...
        updateSelectedCards_V() {
          ...
          var isRecover = this.isRecoverGroupFromFlatGrouped(this.handCardsValue, this.sorthandCardsValue, this.selectCardValue);
        ...
        selected) {
          ...
          for (var _i3 = 0; _i3 < cards.length; _i3++) {
            var c = cards[_i3];
            var count = selectedCount.get(c) || 0;
          ...
          var groupedUsed = new Set();
          var groupedIndexGroups = [];
          var i = 0;
          g;
          ...
          while (i < grouped.length) {
            ...
            for (var k = 0; k < cards.length; k++) {
              ...
              if ((countMap.get(_c) || 0) > 0) {
                idxGroup.push(k);
                countMap.set(_c, countMap.get(_c) - 1);
                groupedUsed.add(k);
              }
            }
          ...
          var sortedSel = [...selectedIndexes].sort((a, b) => a - b);
          return groupedIndexGroups.some(g => {
            var sortedGroup = [...g].sort((a, b) => a - b);
...
//# sourceMappingURL=4e0afaf801963e8caba1d08558eca210c7f76c33.js.map