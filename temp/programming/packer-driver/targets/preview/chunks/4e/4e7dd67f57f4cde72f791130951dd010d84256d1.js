      ...
      (function (_GameLogic) {
        ...
        function findLiandui(cards) {
          ...
          for (var card of normalCards) {
            var rank = getCardRank(card);
            if (rank == 2 || rank > 13) continue; // 排除2和王
        ...
        function findFeiji(cards) {
          ...
          for (var card of normalCards) {
            var rank = getCardRank(card);
            if (rank == 2 || rank > 13) continue; // 排除 2 和王
        ...
        function getCardTypeByFeiji(cards) {
          ...
          for (var card of normalCards) {
            var rank = getCardRank(card);
            if (rank == 2 || rank > 13) return (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              error: Error()
...
//# sourceMappingURL=4e7dd67f57f4cde72f791130951dd010d84256d1.js.map