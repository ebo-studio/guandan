      ...
      (function (_GameLogic) {
        ...
        function moveSelectedCardsToBack(cards, selected, prevSelected, prevGrouped) {
          ...
          for (var indexes of rankMap.values()) {
            ...
            var hasSelected = indexes.some(i => selectedIndexSet.has(i));

            if (hasSelected) {
              moveToBack.push(_group9); // 放末尾
            } else {
              result.push(_group9); // 保持原顺序
            }
          ...
          switch (type) {
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i22 = groupedCards.length - 1; _i22 >= 0; _i22--) {
                var _group10 = groupedCards[_i22];
              ...
              for (var _i23 = groupedCards.length - 1; _i23 >= 0; _i23--) {
                var _group11 = groupedCards[_i23];
              ...
              for (var _i24 = groupedCards.length - 1; _i24 >= 0; _i24--) {
                var _group12 = groupedCards[_i24];
              ...
              for (var _i25 = result_three.length - 1; _i25 >= 0; _i25--) {
                var _group13 = result_three[_i25]; // if (group.length == 4) {
              ...
              for (var _i26 = result.length - 1; _i26 >= 0; _i26--) {
                var _group14 = result[_i26]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i28 = groupedCards.length - 1; _i28 >= 0; _i28--) {
                var _group16 = groupedCards[_i28];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i29 = groupedCards.length - 1; _i29 >= 0; _i29--) {
                var _group17 = groupedCards[_i29];
              ...
              for (var _i30 = groupedCards.length - 1; _i30 >= 0; _i30--) {
                var _group18 = groupedCards[_i30];
              ...
              for (var _i32 = result_three1.length - 1; _i32 >= 0; _i32--) {
                var _group20 = result_three1[_i32]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i33 = result1.length - 1; _i33 >= 0; _i33--) {
                var _group21 = result1[_i33]; // if (group.length == 4) {
                // const bombs = newfindBombs(group);
              ...
              for (var _i35 = groupedCards.length - 1; _i35 >= 0; _i35--) {
                var _group23 = groupedCards[_i35];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            }), GameDefine) : GameDefine).KIND_CARDS_3:
              {
                ...
                for (var _i36 = groupedCards.length - 1; _i36 >= 0; _i36--) {
                  var _group24 = groupedCards[_i36];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i38 = groupedCards.length - 1; _i38 >= 0; _i38--) {
                var _group25 = groupedCards[_i38];
            ...
            case (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
              ...
              for (var _i40 = groupedCards.length - 1; _i40 >= 0; _i40--) {
                var _group27 = groupedCards[_i40];
          ...
          if (targetType === (_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            ...
            if (hintList.length === 0) {
              for (var _i45 = groupedCards.length - 1; _i45 >= 0; _i45--) {
                var _group32 = groupedCards[_i45];
            ...
            if (hintList.length === 0) {
              for (var _i46 = groupedCards.length - 1; _i46 >= 0; _i46--) {
                var _group33 = groupedCards[_i46];
            ...
            if (hintList.length === 0) {
              for (var _i47 = groupedCards.length - 1; _i47 >= 0; _i47--) {
                var _group34 = groupedCards[_i47];
...
//# sourceMappingURL=9eec5959ff7dbabac7d615d42bdd84c901ab90da.js.map