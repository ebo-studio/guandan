...
export class CardAction extends Component {
    ...
    playAction(data: { viewId: number, cardType: number, cardNum: number }) {
        ...
        if (data.cardType == GameDefine.KIND_CARDS_3) { //三不带
            ...
            spAction.setAnimation(0, "ani_twzha", false);
        }
