...
/**常量定义 */
 ...
 namespace apeng {
     ...
     */
        ...
        /**浮点数限定位数 */
        static numCount(num: number, count: number): number;
...
/**启动入口 主逻辑运行处*/
 ...
 namespace apeng {
    ...
    class Vector2 implements IVector2 {
        ...
        /**两个向量的夹角角度 */
        static twoAngle(a: IVector2, b: IVector2, orgin?: IVector2): number;
 ...
 namespace apeng {
    class UIOpacityAnimCC extends BaseComponent {
        backupDescribe: string;
        speed: number;
        showEaseType: EEaseType;
        hideSpeed: number;
 ...
 */
 ...
 namespace apeng {
    ...
    export class UIModule extends BaseModuleEvent {
       ...
       */
         ...
         * 关闭指定的ui
         */
        closeAll(layer: EUILayer, exclude?: string[]): this;
        /**
         * 销毁一个ui
         * @param url
         */
 ...
 namespace apeng {
    class RewardedVideoPlatformLogic extends BaseModule {
        ...
        /**
         * 拉起激励视频广告
         * @param report 视频汇报点， 自动加上前缀 ad_rewardVideo_
         * @param cb
         * @returns
         */
 ...
 namespace apeng {
    class P2Group<T extends number> {
        ...
        getEntityTypeByGroup(type: T): {
            [type: number]: number;
        }[T];
        getEntityTypeByMask(type: T): {
            [type: number]: number;
        }[T];
